...
function v(a,b){a.prototype=ia(b.prototype);a.prototype.constructor=a;if(oa)oa(a,b);else for(var c in b)if("prototype"!=c)if(Object.defineProperties){var d=Object.getOwnPropertyDescriptor(b,c);d&&Object.defineProperty(a,c,d)}else a[c]=b[c];a.M=b.prototype}
...
function b(p){for(var u=g,r=0;64>r;r+=4)u[r/4]=p[r]<<24|p[r+1]<<16|p[r+2]<<8|p[r+3];for(r=16;80>r;r++)p=u[r-3]^u[r-8]^u[r-14]^u[r-16],u[r]=(p<<1|p>>>31)&4294967295;p=e[0];var F=e[1],W=e[2],ha=e[3],Mc=e[4];for(r=0;80>r;r++){if(40>r)if(20>r){var Ia=ha^F&(W^ha);var Gb=1518500249}else Ia=F^W^ha,Gb=1859775393;else 60>r?(Ia=F&W|ha&(F|W),Gb=2400959708):(Ia=F^W^ha,Gb=3395469782);Ia=((p<<5|p>>>27)&4294967295)+Ia+Mc+Gb+u[r]&4294967295;Mc=ha;ha=W;W=(F<<30|F>>>2)&4294967295;F=p;p=Ia}e[0]=e[0]+p&4294967295;e[1]=
e[1]+F&4294967295;e[2]=e[2]+W&4294967295;e[3]=e[3]+ha&4294967295;e[4]=e[4]+Mc&4294967295}
function c(p,u){if("string"===typeof p){p=unescape(encodeURIComponent(p));for(var r=[],F=0,W=p.length;F<W;++F)r.push(p.charCodeAt(F));p=r}u||(u=p.length);r=0;if(0==l)for(;r+64<u;)b(p.slice(r,r+64)),r+=64,m+=64;for(;r<u;)if(f[l++]=p[r++],m++,64==l)for(l=0,b(f);r+64<u;)b(p.slice(r,r+64)),r+=64,m+=64}
function d(){var p=[],u=8*m;56>l?c(h,56-l):c(h,64-(l-56));for(var r=63;56<=r;r--)f[r]=u&255,u>>>=8;b(f);for(r=u=0;5>r;r++)for(var F=24;0<=F;F-=8)p[u++]=e[r]>>F&255;return p}
for(var e=[],f=[],g=[],h=[128],k=1;64>k;++k)h[k]=0;var l,m;a();return{reset:a,update:c,digest:d,za:function(){for(var p=d(),u="",r=0;r<p.length;r++)u+="0123456789ABCDEF".charAt(Math.floor(p[r]/16))+"0123456789ABCDEF".charAt(p[r]%16);return u}}}
...
function Pe(a,b){var c=b.format||"JSON";a=Ne(a,b);var d=Oe(a,b),e=!1,f=Qe(a,function(k){if(!e){e=!0;h&&U(h);var l=Fe(k),m=null,p=400<=k.status&&500>k.status,u=500<=k.status&&600>k.status;if(l||p||u)m=Re(c,k,b.qb);if(l)a:if(k&&204==k.status)l=!0;else{switch(c){case "XML":l=0==parseInt(m&&m.return_code,10);break a;case "RAW":l=!0;break a}l=!!m}m=m||{};p=b.context||x;l?b.onSuccess&&b.onSuccess.call(p,k,m):b.onError&&b.onError.call(p,k,m);b.ja&&b.ja.call(p,k,m)}},b.method,d,b.headers,b.responseType,b.withCredentials);
...
cf.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var Ua=z("ytEventsEventsListeners")||{};y("ytEventsEventsListeners",Ua,void 0);var ef=z("ytEventsEventsCounter")||{count:0};y("ytEventsEventsCounter",ef,void 0);
...
;function of(){}
v(of,lf);function nf(a,b,c){isNaN(c)&&(c=void 0);var d=z("yt.scheduler.instance.addJob");return d?d(a,b,c):void 0===c?(a(),NaN):T(a,c||0)}
...
;var uf=z("ytPubsubPubsubInstance")||new P;P.prototype.subscribe=P.prototype.subscribe;P.prototype.unsubscribeByKey=P.prototype.O;P.prototype.publish=P.prototype.N;P.prototype.clear=P.prototype.clear;y("ytPubsubPubsubInstance",uf,void 0);var vf=z("ytPubsubPubsubSubscribedKeys")||{};y("ytPubsubPubsubSubscribedKeys",vf,void 0);var wf=z("ytPubsubPubsubTopicToKeys")||{};y("ytPubsubPubsubTopicToKeys",wf,void 0);var xf=z("ytPubsubPubsubIsSynchronous")||{};y("ytPubsubPubsubIsSynchronous",xf,void 0);
...
function zf(){return z("ytPubsubPubsubInstance")}
...
;var Zf=z("ytLoggingGelSequenceIdObj_")||{};y("ytLoggingGelSequenceIdObj_",Zf,void 0);
...
v(kg,Error);function lg(a){var b=this;this.f=null;a?this.f=a:bg()&&(this.f=Vf());nf(function(){jg(b)},0,5E3)}
...
sa:d.P,onSuccess:function(u,r){if(d.onSuccess)d.onSuccess(r)},
ra:function(u){if(d.onSuccess)d.onSuccess(u)},
onError:function(u,r){if(d.onError)d.onError(r)},
ub:function(u){if(d.onError)d.onError(u)},
timeout:d.timeout,withCredentials:!0},f="",g=a.f.Ja;g&&(f=g);g=a.f.Ka||!1;var h=cg(g,f,d);Object.assign(e.headers,h);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var k=ve(""+f+("/youtubei/"+a.f.innertubeApiVersion+"/"+b),{alt:"json",key:a.f.innertubeApiKey}),l;if(d.retry&&S("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(l=hg(b,c,h,g))){var m=e.onSuccess,p=e.ra;e.onSuccess=function(u,r){ig(l);m(u,r)};
c.ra=function(u,r){ig(l);p(u,r)}}try{S("use_fetch_for_op_xhr")?Me(k,e):(e.method="POST",e.B||(e.B={}),Pe(k,e))}catch(u){if("InvalidAccessError"==u.name)l&&(ig(l),l=0),re(Error("An extension is blocking network request."));
else throw u;}l&&nf(function(){jg(a)},0,5E3)}
...
window.yterr||f)&&!(5<=pg)&&0!==a.f)){var g=gc(a);f=g.message||"Unknown Error";d=g.name||"UnknownError";e=g.lineNumber||"Not available";var h=g.fileName||"Not available";g=g.stack||a.g||"Not available";if(a.hasOwnProperty("args")&&a.args&&a.args.length)for(var k=0,l=0;l<a.args.length;l++){var m=a.args[l],p="params."+l;k+=p.length;if(m)if(Array.isArray(m))for(var u=c,r=0;r<m.length&&!(m[r]&&(k+=tg(r,m[r],p,u),500<k));r++);else if("object"===typeof m)for(u in u=void 0,r=c,m){if(m[u]&&(k+=tg(u,m[u],
p,r),500<k))break}else c[p]=String(JSON.stringify(m)).substring(0,500),k+=c[p].length;else c[p]=String(JSON.stringify(m)).substring(0,500),k+=c[p].length;if(500<=k)break}else if(a.hasOwnProperty("params")&&a.params)if(m=a.params,"object"===typeof a.params)for(l in p=0,m){if(m[l]&&(k="params."+l,u=String(JSON.stringify(m[l])).substr(0,500),c[k]=u,p+=k.length+u.length,500<p))break}else c.params=String(JSON.stringify(m)).substr(0,500);c={message:f,name:d,lineNumber:e,fileName:h,stack:g,params:c};a=Number(a.columnNumber);
...
return a.join("")}
;var $g=z("ytLoggingDocDocumentNonce_")||Zg();y("ytLoggingDocDocumentNonce_",$g,void 0);var ah=1;function bh(a){this.f=a}
...
v(Ah,nh);var wh=new oh("screen-created",Ah),Bh=[],Ch=0;function Dh(a,b,c){var d=S("use_default_events_client")?void 0:lg;b={csn:a,parentVe:ch(b),childVes:Ka(c,function(f){return ch(f)})};
...
v(Gh,N);Gh.prototype.o=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.pb)}N.prototype.o.call(this)};var Hh=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Ih(a){a=a||"";if(window.spf){var b=a.match(Hh);spf.style.load(a,b?b[1]:"",void 0)}else Jh(a)}
...
v(Mh,N);n=Mh.prototype;n.getId=function(){return this.V};
...
v(ii,hi);function ji(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(sd(a),d.i))}}
...
v(ki,N);n=ki.prototype;n.start=function(){this.j||this.g||(this.j=!0,ji(this.f,"RECEIVING"))};
...
v(oi,ki);oi.prototype.addEventListener=function(a,b){this.i.addEventListener(a,b)};
...
v(pi,N);pi.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.A)}catch(e){re(e)}}};
...
v(xi,G);function yi(){this.g=0;this.f=null}
...
v(Bi,G);Bi.prototype.name="BiscottiError";function Ci(){G.call(this,"Biscotti ID is missing from server")}
v(Ci,G);Ci.prototype.name="BiscottiMissingError";var wi={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Di=null;function le(){if("1"===Sa(ie(),"args","privembed"))return Dd(Error("Biscotti ID is not available in private embed mode"));Di||(Di=Fd(vi().then(Ei),function(a){return Fi(2,a)}));
return Di}
...
v(Si,nh);function Ti(a,b){nh.call(this,1,arguments)}
v(Ti,nh);var Ui=new oh("aft-recorded",Si),Vi=new oh("timing-sent",Ti);var Wi=window;function Xi(){this.timing={};this.clearResourceTimings=function(){};
