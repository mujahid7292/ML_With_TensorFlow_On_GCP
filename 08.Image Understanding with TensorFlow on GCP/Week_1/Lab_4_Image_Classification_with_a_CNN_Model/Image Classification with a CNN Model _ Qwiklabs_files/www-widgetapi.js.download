...
function b(m){for(var r=k,p=0;64>p;p+=4)r[p/4]=m[p]<<24|m[p+1]<<16|m[p+2]<<8|m[p+3];for(p=16;80>p;p++)m=r[p-3]^r[p-8]^r[p-14]^r[p-16],r[p]=(m<<1|m>>>31)&4294967295;m=e[0];var v=e[1],x=e[2],D=e[3],L=e[4];for(p=0;80>p;p++){if(40>p)if(20>p){var ea=D^v&(x^D);var Ca=1518500249}else ea=v^x^D,Ca=1859775393;else 60>p?(ea=v&x|D&(v|x),Ca=2400959708):(ea=v^x^D,Ca=3395469782);ea=((m<<5|m>>>27)&4294967295)+ea+L+Ca+r[p]&4294967295;L=D;D=x;x=(v<<30|v>>>2)&4294967295;v=m;m=ea}e[0]=e[0]+m&4294967295;e[1]=e[1]+v&4294967295;
e[2]=e[2]+x&4294967295;e[3]=e[3]+D&4294967295;e[4]=e[4]+L&4294967295}
...
var m=n.fileName||"Not available";n=n.stack||f.g||"Not available";if(f.hasOwnProperty("args")&&f.args&&f.args.length){var r=0;for(l=0;l<f.args.length;l++){var p=f.args[l],v="params."+l;r+=v.length;if(p)if(Array.isArray(p))for(var x=k,D=0;D<p.length&&!(p[D]&&(r+=Be(D,p[D],v,x),500<r));D++);else if("object"===typeof p)for(x in x=void 0,D=k,p){if(p[x]&&(r+=Be(x,p[x],v,D),500<r))break}else k[v]=String(JSON.stringify(p)).substring(0,500),r+=k[v].length;else k[v]=String(JSON.stringify(p)).substring(0,500),
