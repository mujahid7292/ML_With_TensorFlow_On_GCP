...
a&&Kpa(a,a.g.df(!0))},o5=function(a){this.app=this.name=this.id="";
...
this.l=b;this.B=c;this.w=d||1;this.o=45E3;this.ba=new g.sZ(this);this.i=new g.gl;this.i.setInterval(250)},Y5=function(a,b,c){a.Lh=1;
a.Lf=g5(b.clone());a.fh=c;a.u=!0;X5(a,null)},Z5=function(a,b,c,d,e){a.Lh=1;
a.Lf=g5(b.clone());a.fh=null;a.u=c;e&&(a.Uy=!1);X5(a,d)},X5=function(a,b){a.si=(0,g.A)();
$5(a);a.qg=a.Lf.clone();h5(a.qg,"t",a.w);a.Ek=0;a.uc=a.g.Io(a.g.rk()?b:null);0<a.mp&&(a.jn=new g.jl((0,g.x)(a.Sz,a,a.uc),a.mp));a.ba.ea(a.uc,"readystatechange",a.SK);var c=a.Mg?g.bc(a.Mg):{};a.fh?(a.On="POST",c["Content-Type"]="application/x-www-form-urlencoded",a.uc.send(a.qg,a.On,a.fh,c)):(a.On="GET",a.Uy&&!g.Ld&&(c.Connection="close"),a.uc.send(a.qg,a.On,null,c));a.g.ne(1)},g6=function(a,b,c){for(var d=!0;!a.Ag&&a.Ek<c.length;){var e=bqa(a,c);
if(e==a6){4==b&&(a.ag=4,b6(15),d=!1);break}else if(e==c6){a.ag=4;b6(16);d=!1;break}else d6(a,e)}4==b&&0==c.length&&(a.ag=1,b6(17),d=!1);a.oe=a.oe&&d;d||(e6(a),f6(a))},bqa=function(a,b){var c=a.Ek,d=b.indexOf("\n",c);
if(-1==d)return a6;c=Number(b.substring(c,d));if(isNaN(c))return c6;d+=1;if(d+c>b.length)return a6;var e=b.substr(d,c);a.Ek=d+c;return e},j6=function(a,b){a.si=(0,g.A)();
$5(a);var c=b?window.location.hostname:"";a.qg=a.Lf.clone();f5(a.qg,"DOMAIN",c);f5(a.qg,"t",a.w);try{a.ue=new ActiveXObject("htmlfile")}catch(n){e6(a);a.ag=7;b6(22);f6(a);return}var d="<html><body>";if(b){for(var e="",f=0;f<c.length;f++){var k=c.charAt(f);if("<"==k)e+="\\x3c";else if(">"==k)e+="\\x3e";else{var l=k;if(l in h6)k=h6[l];else if(l in i6)k=h6[l]=i6[l];else{var m=l.charCodeAt(0);if(31<m&&127>m)k=l;else{if(256>m){if(k="\\x",16>m||256<m)k+="0"}else k="\\u",4096>m&&(k+="0");k+=m.toString(16).toUpperCase()}k=
h6[l]=k}e+=k}}d+='<script>document.domain="'+e+'"\x3c/script>'}c=g.Rc(g.qc("b/12014412"),d+"</body></html>");a.ue.open();a.ue.write(g.Mc(c));a.ue.close();a.ue.parentWindow.m=(0,g.x)(a.iK,a);a.ue.parentWindow.d=(0,g.x)(a.by,a,!0);a.ue.parentWindow.rpcClose=(0,g.x)(a.by,a,!1);c=a.ue.createElement("DIV");a.ue.parentWindow.document.body.appendChild(c);d=g.Bc(a.qg.toString());d=g.Zc(g.zc(d));d=g.Rc(g.qc("b/12014412"),'<iframe src="'+d+'"></iframe>');g.Sc(c,d);a.g.ne(1)},$5=function(a){a.Ur=(0,g.A)()+a.o;
k6(a,a.o)},k6=function(a,b){if(null!=a.Hi)throw Error("WatchDog timer not null");
a.Hi=l6((0,g.x)(a.qK,a),b)},m6=function(a){a.Hi&&(g.u.clearTimeout(a.Hi),a.Hi=null)},f6=function(a){a.g.Uu()||a.Ag||a.g.Zm(a)},e6=function(a){m6(a);
g.Ci(a.jn);a.jn=null;a.i.stop();g.uZ(a.ba);if(a.uc){var b=a.uc;a.uc=null;b.abort();b.dispose()}a.ue&&(a.ue=null)},d6=function(a,b){try{a.g.Vx(a,b),a.g.ne(4)}catch(c){}},o6=function(a,b,c,d,e){if(0==d)c(!1);
...
this.i=new R5},s6=function(a){var b=r6(a.g,a.Pi,"/mail/images/cleardot.gif");
g5(b);o6(b.toString(),5E3,(0,g.x)(a.eB,a),3,2E3);a.ne(1)},u6=function(a){var b=a.g.D;
if(null!=b)b6(5),b?(b6(11),t6(a.g,a,!1)):(b6(12),t6(a.g,a,!0));else if(a.Ad=new W5(a,void 0,void 0,void 0),a.Ad.Mg=a.kp,b=a.g,b=r6(b,b.rk()?a.rj:null,a.lp),b6(5),!g.Jd||g.nd(10))h5(b,"TYPE","xmlhttp"),Z5(a.Ad,b,!1,a.rj,!1);else{h5(b,"TYPE","html");var c=a.Ad;a=!!a.rj;c.Lh=3;c.Lf=g5(b.clone());j6(c,a)}},v6=function(a){g.wk.call(this);
...
if(3==a.g){var b=a.Wj++,c=a.Il.clone();f5(c,"SID",a.l);f5(c,"RID",b);f5(c,"TYPE","terminate");J6(a,c);b=new W5(a,a.l,b,void 0);b.Lh=2;b.Lf=g5(c.clone());k5(new Image,b.Lf.toString());b.si=(0,g.A)();$5(b)}K6(a)},N6=function(a){a.yB(1,0);
a.Il=r6(a,null,a.jp);M6(a)},I6=function(a){a.Qf&&(a.Qf.abort(),a.Qf=null);
a.Qb&&(a.Qb.cancel(),a.Qb=null);a.ff&&(g.u.clearTimeout(a.ff),a.ff=null);O6(a);a.td&&(a.td.cancel(),a.td=null);a.Wf&&(g.u.clearTimeout(a.Wf),a.Wf=null)},P6=function(a,b){if(0==a.g)throw Error("Invalid operation: sending map when state is closed");
a.i.push(new fqa(a.xG++,b));2!=a.g&&3!=a.g||M6(a)},M6=function(a){a.td||a.Wf||(a.Wf=l6((0,g.x)(a.ay,a),0),a.Eh=0)},S6=function(a,b){if(1==a.g){if(!b){a.Wj=Math.floor(1E5*Math.random());
var c=a.Wj++,d=new W5(a,"",c,void 0);d.Mg=null;var e=Q6(a),f=a.Il.clone();f5(f,"RID",c);f5(f,"CVER","1");J6(a,f);Y5(d,f,e);a.td=d;a.g=2}}else 3==a.g&&(b?R6(a,b):0==a.i.length||a.td||R6(a))},R6=function(a,b){if(b)if(6<a.Bg){a.i=a.o.concat(a.i);
a.o.length=0;var c=a.Wj-1;var d=Q6(a)}else c=b.B,d=b.fh;else c=a.Wj++,d=Q6(a);var e=a.Il.clone();f5(e,"SID",a.l);f5(e,"RID",c);f5(e,"AID",a.Yh);J6(a,e);c=new W5(a,a.l,c,a.Eh+1);c.Mg=null;c.setTimeout(1E4+Math.round(1E4*Math.random()));a.td=c;Y5(c,e,d)},J6=function(a,b){if(a.Qc){var c=a.Qc.wu();
...
return c.join("&")},T6=function(a){a.Qb||a.ff||(a.B=1,a.ff=l6((0,g.x)(a.Zx,a),0),a.yh=0)},V6=function(a){if(a.Qb||a.ff||3<=a.yh)return!1;
a.B++;a.ff=l6((0,g.x)(a.Zx,a),U6(a,a.yh));a.yh++;return!0},t6=function(a,b,c){a.Mn=c;
a.Ae=b.sf;a.w||N6(a)},O6=function(a){null!=a.Fg&&(g.u.clearTimeout(a.Fg),a.Fg=null)},U6=function(a,b){var c=5E3+Math.floor(1E4*Math.random());
a.isActive()||(c*=2);return c*b},X6=function(a,b){if(2==b||9==b){var c=null;
a.Qc&&(c=null);var d=(0,g.x)(a.zL,a);c||(c=new g.Jm("//www.google.com/images/cleardot.gif"),g5(c));n6(c.toString(),1E4,d)}else b6(2);W6(a,b)},W6=function(a,b){a.g=0;
a.Qc&&a.Qc.Ht(b);K6(a);I6(a)},K6=function(a){a.g=0;
a.Ae=-1;if(a.Qc)if(0==a.o.length&&0==a.i.length)a.Qc.Co();else{g.ib(a.o);var b=g.ib(a.i);a.o.length=0;a.i.length=0;a.Qc.Co(b)}},r6=function(a,b,c){var d=g.Rm(c);
if(""!=d.g)b&&g.Lm(d,b+"."+d.g),g.Mm(d,d.u);else{var e=window.location;d=Ppa(e.protocol,b?b+"."+e.hostname:e.hostname,+e.port,c)}a.bj&&g.Mb(a.bj,function(f,k){f5(d,k,f)});
f5(d,"VER",a.Bg);J6(a,d);return d},l6=function(a,b){if(!g.Na(a))throw Error("Fn must not be null and must be a function");
...
this.g=new g.I(this.ZJ,0,this);g.H(this,this.g);this.Tc=5E3;this.i=0;if(g.Na(a))b&&(a=(0,g.x)(a,b));else if(a&&g.Na(a.handleEvent))a=(0,g.x)(a.handleEvent,a);else throw Error("Invalid listener argument");this.l=a},b7=function(a,b,c){this.G=a;
this.w=b;this.l=new g.yn;this.i=new a7(this.cL,this);this.g=null;this.bb=!1;this.u=null;this.D="";this.C=this.o=0;this.B=[];this.I=c||!1},hqa=function(a){return{firstTestResults:[""],
secondTestResults:!a.g.Mn,sessionId:a.g.l,arrayId:a.g.Yh}},c7=function(a,b){a.C=b||0;
...
g7(a.l,c,{screen_ids:b.join(",")},(0,g.x)(a.iC,a),(0,g.x)(a.hC,a))}},s7=function(a){var b=s5(E5());
...
a.l=new t7(a.w);a.l.subscribe("screenChange",(0,g.x)(a.pC,a));G7(a);a.o=s5(g.by("yt-remote-automatic-screen-cache")||[]);H7(a);a.info("Initializing automatic screens: "+u5(a.o));a.i=new x7(a.w,(0,g.x)(a.Kd,a,!0));a.i.subscribe("screenChange",(0,g.x)(function(){this.N("onlineScreenChange")},a))},D7=function(a,b){var c=a.get(b.id);
...
this.g=null;this.o=0;this.w=(0,g.x)(this.fM,this);this.u=(0,g.x)(this.BK,this);this.o=g.Co((0,g.x)(function(){K7(this,null)},this),12E4)},sqa=function(a){a.info("sendYoutubeMessage_: getMdxSessionStatus "+g.zj(void 0));
...
if(b){if(a.info("onConnectedScreenId_: Received screenId: "+b),!a.l||a.l.id!=b){var c=(0,g.x)(a.bn,a),d=(0,g.x)(a.Md,a);a.Pu(b,c,d,5)}}else a.Md(Error("Waiting for session status timed out."))},M7=function(a,b,c){I7.call(this,a,b,"DialSession");
this.o=this.C=null;this.G="";this.M=c;this.u=null;this.B=g.Ia;this.w=NaN;this.I=(0,g.x)(this.iM,this);this.g=g.Ia},N7=function(a){a.g=a.D.Yz(a.G,a.i.label,a.i.friendlyName,(0,g.x)(function(b){this.g=g.Ia;
this.bn(b)},a),(0,g.x)(function(b){this.g=g.Ia;
...
this.g=g.Co((0,g.x)(this.Zh,this,null),150)},Q7=function(a,b,c,d){g.O.call(this);
this.i=a;this.B=b||"233637DE";this.w=c||"cl";this.C=d||!1;this.g=null;this.u=!1;this.l=[];this.o=(0,g.x)(this.iJ,this)},R7=function(a,b){return b?g.Ya(a.l,function(c){return q5(b,c.label)},a):null},S7=function(a){l7("Controller",a)},h7=function(a){window.chrome&&chrome.cast&&chrome.cast.logMessage&&chrome.cast.logMessage(a)},T7=function(a){return a.u||!!a.l.length||!!a.g},U7=function(a,b,c){b!=a.g&&(g.Ci(a.g),(a.g=b)?(c?a.N("yt-remote-cast2-receiver-resumed",b.i):a.N("yt-remote-cast2-receiver-selected",
b.i),b.subscribe("sessionScreen",(0,g.x)(a.Yx,a,b)),b.l?a.N("yt-remote-cast2-session-change",b.l):c&&a.g.Zh(null)):a.N("yt-remote-cast2-session-change",null))},V7=function(a){var b=a.i.Xz(),c=a.g&&a.g.i;
...
this.g=0;this.o=a;this.w=[];this.u=new $6;this.l=this.i=null;this.D=(0,g.x)(this.fH,this);this.B=(0,g.x)(this.Zj,this);this.C=(0,g.x)(this.eH,this);this.G=(0,g.x)(this.rH,this);var c=0;a?(c=a.getProxyState(),3!=c&&(a.subscribe("proxyStateChange",this.Xr,this),s8(this))):c=3;0!=c&&(b?this.Xr(c):g.Co((0,g.x)(function(){this.Xr(c)},this),0));
...
a.o.setPlayerContextData(r8(b));s8(a)},t8=function(a,b){a.l&&(a.l.removeUpdateListener(a.D),a.l.removeMediaListener(a.B),a.Zj(null));
a.l=b;a.l&&(l7("CP","Setting cast session: "+a.l.sessionId),a.l.addUpdateListener(a.D),a.l.addMediaListener(a.B),a.l.media.length&&a.Zj(a.l.media[0]))},B8=function(a){var b=a.i.media,c=a.i.customData;
...
this.u=NaN;this.I=!1;this.C=this.B=this.D=this.G=NaN;this.R=[];this.o=this.w=this.l=this.Na=this.g=null;this.P=a;this.R.push(g.Zq(window,"beforeunload",(0,g.x)(this.bC,this)));this.i=[];this.Na=new l8;this.M=b.id;this.g=yqa(this,c);this.g.subscribe("handlerOpened",this.jH,this);this.g.subscribe("handlerClosed",this.gH,this);this.g.subscribe("handlerError",this.hH,this);this.g.subscribe("handlerMessage",this.iH,this);iqa(this.g,b.token);this.subscribe("remoteQueueChange",function(){var d=this.Na.videoId;
...
this.Ch(1)},a),2E4)},G8=function(a){g.Eo(a.u);
...
b==(d7(a.g)&&isNaN(a.u))?b&&(F8(a,1),J8(a,"getSubtitlesTrack")):b?(a.Nu()&&a.Na.reset(),F8(a,1),J8(a,"getNowPlaying"),K8(a)):a.Ch(1)},Bqa=function(a,b){var c=b.params.videoId;
...
a.C=g.Co((0,g.x)(a.Ch,a,1),864E5)},J8=function(a,b,c){c?E8("Sending: action="+b+", params="+g.zj(c)):E8("Sending: action="+b);
a.g.sendMessage(b,c)},O8=function(a){p7.call(this,"ScreenServiceProxy");
this.Sc=a;this.i=[];this.i.push(this.Sc.$_s("screenChange",(0,g.x)(this.dM,this)));this.i.push(this.Sc.$_s("onlineScreenChange",(0,g.x)(this.II,this)))},Lqa=function(a){var b={device:"Desktop",
...
this.u=a;this.i=b;this.l=new g.Qs(this);g.H(this,this.l);this.l.J(b,"onCaptionsTrackListChanged",this.dI);this.l.J(b,"captionschanged",this.dH);this.l.J(b,"captionssettingschanged",this.kz);this.l.J(b,"videoplayerreset",this.cn);this.l.J(b,"mdxautoplaycancel",this.dB);this.P=this.l.J(b,"onVolumeChange",this.Gx);this.C=!1;this.g=c;c.subscribe("proxyStateChange",this.Ux,this);c.subscribe("remotePlayerChange",this.bk,this);c.subscribe("remoteQueueChange",this.cn,this);c.subscribe("autoplayUpNext",this.wx,
this);c.subscribe("previousNextChange",this.Rx,this);c.subscribe("nowAutoplaying",this.Nx,this);c.subscribe("autoplayDismissed",this.vx,this);this.suggestion=null;this.D=new g.Ct(64);this.o=new g.I(this.iz,500,this);g.H(this,this.o);this.w=new g.I(this.jz,1E3,this);g.H(this,this.w);this.I=new P5(this.IL,0,this);g.H(this,this.I);this.B={};this.R=new g.I(this.Kz,1E3,this);g.H(this,this.R);this.G=new g.jl(this.AE,1E3,this);g.H(this,this.G);this.M=g.Ia;this.kz();this.cn();this.bk()},j9=function(a,b){var c=
...
b&&(c={style:a.i.getSubtitlesUserSettings()},g.ec(c,b));a.g.Zy(a.i.getVideoData(1).videoId,c);a.B=v8(a.g).g}},n9=function(a,b){var c=a.i.getPlaylist();
if(c){var d=c.Qa;var e=c.listId.toString()}c=a.i.getVideoData(1);a.g.playVideo(c.videoId,b,d,e,c.playerParams,c.De,i5(c));k9(a,new g.Ct(1))},Rqa=function(a,b){if(b){var c=a.i.getOption("captions","tracklist",{RP:1});
...
this.i={key:v5(),name:"This computer"};this.u=null;this.o=[];this.M=this.g=null;this.G=[this.i];this.l=this.i;this.B=new g.Ct(64);this.R=0;this.D=-1;this.w=null;if(!g.fz(this.player.L())){a=this.player;var b=g.RC(a);b&&(b=b.Jm())&&(b=new q9(a,b),g.H(this,b));b=new p9(a);g.H(this,b);g.DK(a,b.element,4);this.w=new o9;g.H(this,this.w);g.DK(a,this.w.element,4);this.I=!!W8()}this.C=null},s9=function(a){a.C&&(a.player.removeEventListener("presentingplayerstatechange",a.C),a.C=null)},Sqa=function(a,b,c){a.B=
c;
a.player.N("presentingplayerstatechange",new g.hD(c,b))},t9=function(a,b){if(b.key!=a.l.key)if(b.key==a.i.key)b9();
else{var c;(c=!g.P(a.player.L().experiments,"mdx_enable_privacy_disclosure_ui"))||(c=((c=g.uo("PLAYER_CONFIG"))&&c.args&&void 0!==c.args.authuser?!0:!(!g.uo("SESSION_INDEX")&&!g.uo("LOGGED_IN")))||a.I||!a.w);if(c?0:"WEB"==a.player.L().deviceParams.c||"WEB_EMBEDDED_PLAYER"==a.player.L().deviceParams.c)g.Jt(g.lK(a.player))?a.player.pauseVideo():(a.C=(0,g.x)(a.GK,a),a.player.addEventListener("presentingplayerstatechange",a.C)),a.w&&a.w.l.show(),$8()||(g9=!0);a.l=b;var d=a.player.getPlaylistId();c=a.player.getVideoData(1);
...
"\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t","\x0B":"\\x0B",'"':'\\"',"\\":"\\\\","<":"\\u003C"},h6={"'":"\\'"},Uqa={},Tpa={GM:"atp",dP:"ska",SO:"que",tO:"mus",cP:"sus",HN:"dsp",ZO:"seq"};
o5.prototype.Rf=function(){var a=new o5({id:this.id,name:this.name,app:this.app,type:this.type,user:this.username,userAvatarUri:this.avatar,obfuscatedGaiaId:this.obfuscatedGaiaId,theme:this.theme,capabilities:Array.from(this.capabilities.values()).join(","),experiments:Array.from(this.experiments.values()).join(",")});a.l=this.l;a.i=this.i;a.g=this.g};
var H5,A5="",$pa=J5("loadCastFramework")||J5("loadCastApplicationFramework"),vqa=["pkedcjkdefgpdelpbcmbmeomcjbeemfm","enhhojjnijigcajfphajepfemndkmdlo"];g.Ta(P5,g.E);g.h=P5.prototype;g.h.XB=function(a){this.o=arguments;this.g=!1;this.za?this.l=(0,g.A)()+this.Tc:this.za=g.hl(this.u,this.Tc)};
...
g.h.YB=function(){this.l?(this.za=g.hl(this.u,this.l-(0,g.A)()),this.l=null):(this.za=null,this.i?this.g=!0:(this.g=!1,this.w.apply(null,this.o)))};R5.prototype.stringify=function(a){return g.u.JSON.stringify(a,void 0)};
R5.prototype.parse=function(a){return g.u.JSON.parse(a,void 0)};S5.prototype.g=null;S5.prototype.getOptions=function(){var a;(a=this.g)||(a={},U5(this)&&(a[0]=!0,a[1]=!0),a=this.g=a);return a};var u9;g.Ta(T5,S5);u9=new T5;g.h=W5.prototype;g.h.Mg=null;g.h.oe=!1;g.h.Hi=null;g.h.Ur=null;g.h.si=null;g.h.Lh=null;g.h.Lf=null;g.h.qg=null;g.h.fh=null;g.h.uc=null;g.h.Ek=0;g.h.ue=null;g.h.On=null;g.h.ag=null;g.h.sj=-1;g.h.Uy=!0;g.h.Ag=!1;g.h.mp=0;g.h.jn=null;var c6={},a6={};g.h=W5.prototype;g.h.setTimeout=function(a){this.o=a};
g.h.SK=function(a){a=a.target;var b=this.jn;b&&3==z6(a)?b.Ul():this.Sz(a)};
g.h.Sz=function(a){try{if(a==this.uc)a:{var b=z6(this.uc),c=this.uc.w,d=this.uc.getStatus();if(g.Jd&&!g.nd(10)||g.Ld&&!g.ld("420+")){if(4>b)break a}else if(3>b||3==b&&!g.bg&&!D6(this.uc))break a;this.Ag||4!=b||7==c||(8==c||0>=d?this.g.ne(3):this.g.ne(2));m6(this);var e=this.uc.getStatus();this.sj=e;var f=D6(this.uc);(this.oe=200==e)?(4==b&&e6(this),this.u?(g6(this,b,f),g.bg&&this.oe&&3==b&&(this.ba.ea(this.i,"tick",this.MK),this.i.start())):d6(this,f),this.oe&&!this.Ag&&(4==b?this.g.Zm(this):(this.oe=
!1,$5(this)))):(400==e&&0<f.indexOf("Unknown SID")?(this.ag=3,b6(13)):(this.ag=0,b6(14)),e6(this),f6(this))}}catch(k){this.uc&&D6(this.uc)}finally{}};
g.h.MK=function(){var a=z6(this.uc),b=D6(this.uc);this.Ek<b.length&&(m6(this),g6(this,a,b),this.oe&&4!=a&&$5(this))};
g.h.iK=function(a){l6((0,g.x)(this.hK,this,a),0)};
g.h.hK=function(a){this.Ag||(m6(this),d6(this,a),$5(this))};
g.h.by=function(a){l6((0,g.x)(this.gK,this,a),0)};
g.h.gK=function(a){this.Ag||(e6(this),this.oe=a,this.g.Zm(this),this.g.ne(4))};
g.h.cancel=function(){this.Ag=!0;e6(this)};
g.h.qK=function(){this.Hi=null;var a=(0,g.A)();0<=a-this.Ur?(2!=this.Lh&&this.g.ne(3),e6(this),this.ag=2,b6(18),f6(this)):k6(this,this.Ur-a)};
g.h.getLastError=function(){return this.ag};g.h=q6.prototype;g.h.kp=null;g.h.Ad=null;g.h.kn=!1;g.h.Vu=null;g.h.Gl=null;g.h.Op=null;g.h.lp=null;g.h.be=null;g.h.sf=-1;g.h.rj=null;g.h.Pi=null;g.h.connect=function(a){this.lp=a;a=r6(this.g,null,this.lp);b6(3);this.Vu=(0,g.A)();var b=this.g.C;null!=b?(this.rj=b[0],(this.Pi=b[1])?(this.be=1,s6(this)):(this.be=2,u6(this))):(h5(a,"MODE","init"),this.Ad=new W5(this,void 0,void 0,void 0),this.Ad.Mg=this.kp,Z5(this.Ad,a,!1,null,!0),this.be=0)};
g.h.eB=function(a){if(a)this.be=2,u6(this);else{b6(4);var b=this.g;b.Ae=b.Qf.sf;X6(b,9)}a&&this.ne(2)};
g.h.Io=function(a){return this.g.Io(a)};
g.h.abort=function(){this.Ad&&(this.Ad.cancel(),this.Ad=null);this.sf=-1};
g.h.Uu=function(){return!1};
g.h.Vx=function(a,b){this.sf=a.sj;if(0==this.be)if(b){try{var c=this.i.parse(b)}catch(d){c=this.g;c.Ae=this.sf;X6(c,2);return}this.rj=c[0];this.Pi=c[1]}else c=this.g,c.Ae=this.sf,X6(c,2);else if(2==this.be)if(this.kn)b6(7),this.Op=(0,g.A)();else if("11111"==b){if(b6(6),this.kn=!0,this.Gl=(0,g.A)(),c=this.Gl-this.Vu,!g.Jd||g.nd(10)||500>c)this.sf=200,this.Ad.cancel(),b6(12),t6(this.g,this,!0)}else b6(8),this.Gl=this.Op=(0,g.A)(),this.kn=!1};
g.h.Zm=function(){this.sf=this.Ad.sj;if(this.Ad.oe)0==this.be?this.Pi?(this.be=1,s6(this)):(this.be=2,u6(this)):2==this.be&&((!g.Jd||g.nd(10)?!this.kn:200>this.Op-this.Gl)?(b6(11),t6(this.g,this,!1)):(b6(12),t6(this.g,this,!0)));else{0==this.be?b6(9):2==this.be&&b6(10);var a=this.g;this.Ad.getLastError();a.Ae=this.sf;X6(a,2)}};
...
g.h.send=function(a,b,c,d){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);b=b?b.toUpperCase():"GET";this.D=a;this.o="";this.w=0;this.W=b;this.P=!1;this.l=!0;this.g=this.M?V5(this.M):V5(u9);this.R=this.M?this.M.getOptions():u9.getOptions();this.g.onreadystatechange=(0,g.x)(this.Wu,this);try{l5(A6(this,"Opening Xhr")),this.aa=!0,this.g.open(b,String(a),!0),this.aa=!1}catch(f){l5(A6(this,"Error opening Xhr: "+f.message));y6(this,f);return}a=c||"";
...
g.h.Wu=function(){this.fa()||(this.aa||this.C||this.u?B6(this):this.hJ())};
g.h.hJ=function(){B6(this)};
g.h.isActive=function(){return!!this.g};
g.h.getStatus=function(){try{return 2<z6(this)?this.g.status:-1}catch(a){return-1}};
g.h.getLastError=function(){return"string"===typeof this.o?this.o:String(this.o)};g.h=E6.prototype;g.h.bj=null;g.h.td=null;g.h.Qb=null;g.h.jp=null;g.h.Il=null;g.h.qt=null;g.h.Vl=null;g.h.Wj=0;g.h.xG=0;g.h.Qc=null;g.h.Wf=null;g.h.ff=null;g.h.Fg=null;g.h.Qf=null;g.h.Mn=null;g.h.Yh=-1;g.h.Iv=-1;g.h.Ae=-1;g.h.Eh=0;g.h.yh=0;g.h.Bg=8;var Y6=new g.wk;g.Ta(F6,g.Zj);g.Ta(G6,g.Zj);g.Ta(H6,g.Zj);g.h=E6.prototype;g.h.connect=function(a,b,c,d,e){b6(0);this.jp=b;this.bj=c||{};d&&void 0!==e&&(this.bj.OSID=d,this.bj.OAID=e);this.w?(l6((0,g.x)(this.Pt,this,a),100),N6(this)):this.Pt(a)};
g.h.Pt=function(a){this.Qf=new q6(this);this.Qf.kp=null;this.Qf.i=this.u;this.Qf.connect(a)};
g.h.Uu=function(){return 0==this.g};
g.h.ay=function(a){this.Wf=null;S6(this,a)};
g.h.Zx=function(){this.ff=null;this.Qb=new W5(this,this.l,"rpc",this.B);this.Qb.Mg=null;this.Qb.mp=0;var a=this.qt.clone();f5(a,"RID","rpc");f5(a,"SID",this.l);f5(a,"CI",this.Mn?"0":"1");f5(a,"AID",this.Yh);J6(this,a);if(!g.Jd||g.nd(10))f5(a,"TYPE","xmlhttp"),Z5(this.Qb,a,!0,this.Vl,!1);else{f5(a,"TYPE","html");var b=this.Qb,c=!!this.Vl;b.Lh=3;b.Lf=g5(a.clone());j6(b,c)}};
g.h.Vx=function(a,b){if(0!=this.g&&(this.Qb==a||this.td==a))if(this.Ae=a.sj,this.td==a&&3==this.g)if(7<this.Bg){try{var c=this.u.parse(b)}catch(f){c=null}if(g.La(c)&&3==c.length)if(0==c[0])a:{if(!this.ff){if(this.Qb)if(this.Qb.si+3E3<this.td.si)O6(this),this.Qb.cancel(),this.Qb=null;else break a;V6(this);b6(19)}}else this.Iv=c[1],0<this.Iv-this.Yh&&37500>c[2]&&this.Mn&&0==this.yh&&!this.Fg&&(this.Fg=l6((0,g.x)(this.ZG,this),6E3));else X6(this,11)}else b!=Uqa.fN.g&&X6(this,11);else if(this.Qb==a&&
O6(this),!g.yb(b)){c=this.u.parse(b);g.La(c);for(var d=0;d<c.length;d++){var e=c[d];this.Yh=e[0];e=e[1];2==this.g?"c"==e[0]?(this.l=e[1],this.Vl=e[2],e=e[3],null!=e?this.Bg=e:this.Bg=6,this.g=3,this.Qc&&this.Qc.Jt(),this.qt=r6(this,this.rk()?this.Vl:null,this.jp),T6(this)):"stop"==e[0]&&X6(this,7):3==this.g&&("stop"==e[0]?X6(this,7):"noop"!=e[0]&&this.Qc&&this.Qc.It(e),this.yh=0)}}};
g.h.ZG=function(){null!=this.Fg&&(this.Fg=null,this.Qb.cancel(),this.Qb=null,V6(this),b6(20))};
g.h.Zm=function(a){if(this.Qb==a){O6(this);this.Qb=null;var b=2}else if(this.td==a)this.td=null,b=1;else return;this.Ae=a.sj;if(0!=this.g)if(a.oe)1==b?(b=(0,g.A)()-a.si,Y6.dispatchEvent(new G6(Y6,a.fh?a.fh.length:0,b,this.Eh)),M6(this),this.o.length=0):T6(this);else{var c=a.getLastError(),d;if(!(d=3==c||7==c||0==c&&0<this.Ae)){if(d=1==b)this.td||this.Wf||1==this.g||2<=this.Eh?d=!1:(this.Wf=l6((0,g.x)(this.ay,this,a),U6(this,this.Eh)),this.Eh++,d=!0);d=!(d||2==b&&V6(this))}if(d)switch(c){case 1:X6(this,
5);break;case 4:X6(this,10);break;case 3:X6(this,6);break;case 7:X6(this,12);break;default:X6(this,2)}}};
g.h.yB=function(a){if(!g.ab(arguments,this.g))throw Error("Unexpected channel state: "+this.g);};
g.h.zL=function(a){a?b6(2):(b6(1),W6(this,8))};
g.h.Io=function(a){if(a)throw Error("Can't create secondary domain capable XhrIo object.");a=new v6;a.S=!1;return a};
g.h.isActive=function(){return!!this.Qc&&this.Qc.isActive(this)};
g.h.ne=function(a){Y6.dispatchEvent(new H6(Y6,a))};
g.h.rk=function(){return!(!g.Jd||g.nd(10))};
...
g.h.wd=function(){for(var a=[],b=this.g.length-1;0<=b;--b)a.push(this.g[b]);var c=this.i.length;for(b=0;b<c;++b)a.push(this.i[b]);return a};g.Ta(a7,g.E);g.h=a7.prototype;g.h.ZJ=function(){this.Tc=Math.min(3E5,2*this.Tc);this.l();this.i&&this.start()};
...
g.h.Co=function(a){if(!this.i.isActive())this.N("handlerClosed");else if(a)for(var b=0,c=a.length;b<c;++b){var d=a[b].map;d&&this.B.push(d)}};
g.h.wu=function(){var a={v:2};this.D&&(a.gsessionid=this.D);0!=this.o&&(a.ui=""+this.o);0!=this.C&&(a.ui=""+this.C);this.u&&g.ec(a,this.u);return a};
g.h.It=function(a){"S"==a[0]?this.D=a[1]:"gracefulReconnect"==a[0]?(this.i.start(),L6(this.g)):this.N("handlerMessage",new gqa(a[0],a[1]))};
g.h.cL=function(){this.i.isActive();var a=this.g,b=0;a.Qb&&b++;a.td&&b++;0==b&&this.connect(this.u,this.o)};e7.prototype.o=function(a,b,c,d){b?a(d):a({text:c.responseText})};
...
p7.prototype.info=function(a){l7(this.B,a)};g.r(r7,g.O);g.h=r7.prototype;g.h.start=function(){!this.g&&isNaN(this.za)&&this.Wz()};
...
g.h.Wz=function(){this.za=NaN;this.g=g.Ap(f7(this.w,"/pairing/get_screen"),{method:"POST",sb:{pairing_code:this.u},timeout:5E3,onSuccess:(0,g.x)(this.bM,this),onError:(0,g.x)(this.aM,this),Nd:(0,g.x)(this.cM,this)})};
g.h.bM=function(a,b){this.g=null;var c=b.screen||{};c.dialId=this.l;c.name=this.o;this.N("pairingComplete",new p5(c))};
g.h.aM=function(a){this.g=null;a.status&&404==a.status?this.i>=Wqa.length?this.N("pairingFailed",Error("DIAL polling timed out")):(a=Wqa[this.i],this.za=g.Co((0,g.x)(this.Wz,this),a),this.i++):this.N("pairingFailed",Error("Server error "+a.status))};
g.h.cM=function(){this.g=null;this.N("pairingFailed",Error("Server not responding"))};
...
g.h.In=function(a,b,c,d){var e=s7(this),f=this.get(a.id);f?(f.name!=b&&(f.name=b,v7(this,!1),e=!0),c(a)):d(Error("no such local screen."));e&&this.N("screenChange")};
g.h.V=function(){g.Eo(this.i);t7.xb.V.call(this)};
g.h.iC=function(a){s7(this);var b=this.g.length;a=a&&a.screens||[];for(var c=0,d=a.length;c<d;++c){var e=a[c],f=this.get(e.screenId);f&&(f.token=e.loungeToken,--b)}v7(this,!b);b&&l7(this.B,"Missed "+b+" lounge tokens.")};
g.h.hC=function(a){l7(this.B,"Requesting lounge tokens failed: "+a)};g.r(x7,g.O);g.h=x7.prototype;g.h.start=function(){var a=parseInt(g.by("yt-remote-fast-check-period")||"0",10);(this.o=(0,g.A)()-144E5<a?0:a)?A7(this):(this.o=(0,g.A)()+3E5,g.ay("yt-remote-fast-check-period",this.o),this.ir())};
...
g.h.ir=function(){g.Eo(this.l);this.l=NaN;this.i&&this.i.abort();var a=B7(this);if(j5(a)){var b=f7(this.u,"/pairing/get_screen_availability");this.i=g7(this.u,b,{lounge_token:g.Tb(a).join(",")},(0,g.x)(this.DJ,this,a),(0,g.x)(this.CJ,this))}else z7(this,{}),A7(this)};
g.h.DJ=function(a,b){this.i=null;var c=g.Tb(B7(this));if(g.sb(c,g.Tb(a))){c=b.screens||[];for(var d={},e=0,f=c.length;e<f;++e)d[a[c[e].loungeToken]]="online"==c[e].status;z7(this,d);A7(this)}else this.Kb("Changing Screen set during request."),this.ir()};
g.h.CJ=function(a){this.Kb("Screen availability failed: "+a);this.i=null;A7(this)};
...
g.h.In=function(a,b,c,d){this.l.contains(a)?this.l.In(a,b,c,d):(a="Updating name of unknown screen: "+a.name,l7(this.B,a),d(Error(a)))};
g.h.Kd=function(a){return a?this.g:g.gb(this.g,(0,g.Wd)(this.o,function(b){return!this.contains(b)},this))};
g.h.Xz=function(){return(0,g.Wd)(this.Kd(!0),function(a){return!!this.i.g[a.id]},this)};
g.h.Yz=function(a,b,c,d,e){this.info("getDialScreenByPairingCode "+a+" / "+b);var f=new r7(this.w,a,b,c);f.subscribe("pairingComplete",(0,g.x)(function(k){g.Ci(f);d(D7(this,k))},this));
f.subscribe("pairingFailed",function(k){g.Ci(f);e(k)});
f.start();return(0,g.x)(f.stop,f)};
g.h.eM=function(a,b,c,d){g.Ap(f7(this.w,"/pairing/get_screen"),{method:"POST",sb:{pairing_code:a},timeout:5E3,onSuccess:(0,g.x)(function(e,f){var k=new p5(f.screen||{});if(!k.name||F7(this,k.name)){a:{var l=k.name;for(var m=2,n=b(l,m);F7(this,n);){m++;if(20<m)break a;n=b(l,m)}l=n}k.name=l}c(D7(this,k))},this),
...
g.h.pC=function(){G7(this);this.N("screenChange");this.i.update()};
C7.prototype.dispose=C7.prototype.dispose;g.Ta(I7,g.O);g.h=I7.prototype;g.h.bn=function(a){this.l=a;this.N("sessionScreen",this.l)};
...
g.h.BK=function(a,b){if(!this.fa())if(b){var c=Q5(b);if(g.Oa(c)){var d=""+c.type;c=c.data||{};this.info("onYoutubeMessage_: "+d+" "+g.zj(c));switch(d){case "mdxSessionStatus":K7(this,c.screenId);break;default:J7(this,"Unknown youtube message: "+d)}}else J7(this,"Unable to parse message.")}else J7(this,"No data in message.")};
g.h.Pu=function(a,b,c,d){E7(this.D,this.i.label,a,this.i.friendlyName,(0,g.x)(function(e){e?b(e):0<=d?(J7(this,"Screen "+a+" appears to be offline. "+d+" retries left."),g.Co((0,g.x)(this.Pu,this,a,b,c,d-1),300)):c(Error("Unable to fetch screen."))},this),c)};
g.h.aA=function(){return this.g};
g.h.fM=function(a){this.fa()||a||(J7(this,"Cast session died."),this.Md())};g.Ta(M7,I7);g.h=M7.prototype;g.h.sr=function(a){this.o=a;this.o.addUpdateListener(this.I)};
...
g.h.iM=function(a){this.fa()||a||(J7(this,"DIAL session died."),this.g(),this.g=g.Ia,this.Md())};
...
g.h.lL=function(a){this.fa()?this.Kb("Setting connection data on disposed cast v2"):this.g?this.g.Zh(a):this.Kb("Setting connection data without a session")};
g.h.hM=function(){this.fa()?this.Kb("Stopping session on disposed cast v2"):this.g?(this.g.stop(),U7(this,null)):S7("Stopping non-existing session")};
g.h.requestSession=function(){chrome.cast.requestSession((0,g.x)(this.Xx,this),(0,g.x)(this.JJ,this))};
g.h.V=function(){this.i.unsubscribe("onlineScreenChange",(0,g.x)(this.Zz,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.o);g.eb(g.w("yt.mdx.remote.debug.handlers_")||[],h7);g.Ci(this.g);Q7.xb.V.call(this)};
g.h.Kb=function(a){l7("Controller",a)};
g.h.Yx=function(a,b){this.g==a&&(b||U7(this,null),this.N("yt-remote-cast2-session-change",b))};
...
g.h.yH=function(a){if(this.fa())return Promise.reject(Error("disposed"));var b=a.receiver;b.receiverType!=chrome.cast.ReceiverType.DIAL&&(this.Kb("Not DIAL receiver: "+b.friendlyName),b.receiverType=chrome.cast.ReceiverType.DIAL);var c=this.g?this.g.i:null;if(!c||c.label!=b.label)return this.Kb("Receiving DIAL launch request for non-clicked DIAL receiver: "+b.friendlyName),Promise.reject(Error("illegal DIAL launch"));if(c&&c.label==b.label&&c.receiverType!=chrome.cast.ReceiverType.DIAL){if(this.g.l)return S7("Reselecting dial screen."),
this.N("yt-remote-cast2-session-change",this.g.l),Promise.resolve(new chrome.cast.DialLaunchResponse(!1));this.Kb('Changing CAST intent from "'+c.receiverType+'" to "dial" for '+b.friendlyName);U7(this,new M7(this.i,b,this.w))}b=this.g;b.C=a;return b.C.appState==chrome.cast.DialAppState.RUNNING?new Promise((0,g.x)(b.KC,b,(b.C.extraData||{}).screenId||null)):new Promise((0,g.x)(b.Ap,b))};
g.h.Xx=function(a){if(!this.fa()){S7("New cast session ID: "+a.sessionId);var b=a.receiver;if(b.receiverType!=chrome.cast.ReceiverType.CUSTOM){if(!this.g)if(b.receiverType==chrome.cast.ReceiverType.CAST)S7("Got resumed cast session before resumed mdx connection."),b.friendlyName=chrome.cast.unescape(b.friendlyName),U7(this,new L7(this.i,b),!0);else{this.Kb("Got non-cast session without previous mdx receiver event, or mdx resume.");return}var c=this.g.i,d=x5(this.i.Kd(),c.label);d&&q5(d,b.label)&&
c.receiverType!=chrome.cast.ReceiverType.CAST&&b.receiverType==chrome.cast.ReceiverType.CAST&&(S7("onSessionEstablished_: manual to cast session change "+b.friendlyName),g.Ci(this.g),this.g=new L7(this.i,b),this.g.subscribe("sessionScreen",(0,g.x)(this.Yx,this,this.g)),this.g.Zh(null));this.g.sr(a)}}};
g.h.gM=function(){return this.g?this.g.aA():null};
g.h.JJ=function(a){this.fa()||(this.Kb("Failed to estabilish a session: "+g.zj(a)),a.code!=chrome.cast.ErrorCode.CANCEL&&U7(this,null))};
g.h.mJ=function(a){S7("Receiver availability updated: "+a);if(!this.fa()){var b=T7(this);this.u=a==chrome.cast.ReceiverAvailability.AVAILABLE;T7(this)!=b&&this.N("yt-remote-cast2-availability-change",T7(this))}};
g.h.Zz=function(){this.fa()||(this.l=V7(this),S7("Updating custom receivers: "+g.zj(this.l)),chrome.cast.setCustomReceivers(this.l,g.Ia,(0,g.x)(function(){this.Kb("Failed to set custom receivers.")},this)),this.N("yt-remote-cast2-availability-change",T7(this)))};
Q7.prototype.setLaunchParams=Q7.prototype.lL;Q7.prototype.setConnectedScreenStatus=Q7.prototype.kL;Q7.prototype.stopSession=Q7.prototype.hM;Q7.prototype.getCastSession=Q7.prototype.gM;Q7.prototype.requestSession=Q7.prototype.requestSession;Q7.prototype.init=Q7.prototype.init;Q7.prototype.dispose=Q7.prototype.dispose;var d8=[];l8.prototype.reset=function(a){this.listId="";this.index=-1;this.videoId="";m8(this);this.volume=-1;this.muted=!1;a&&(this.index=a.index,this.listId=a.listId,this.videoId=a.videoId,this.playerState=a.playerState,this.volume=a.volume,this.muted=a.muted,this.audioTrackId=a.audioTrackId,this.g=a.trackData,this.Be=a.hasPrevious,this.hasNext=a.hasNext,this.B=a.playerTime,this.w=a.playerTimeAt,this.o=a.seekableStart,this.i=a.seekableEnd,this.C=a.duration,this.D=a.loadedTime,this.l=a.liveIngestionTime,this.u=
!isNaN(this.l))};
...
g.h.Zy=function(a,b){if(1==this.g){var c=v8(this),d={videoId:a};b&&(c.g={trackName:b.name,languageCode:b.languageCode,sourceLanguageCode:b.translationLanguage?b.translationLanguage.languageCode:"",languageName:b.languageName,kind:b.kind},d.style=g.zj(b.style),g.ec(d,c.g));A8(this,"setSubtitlesTrack",d);y8(this,c)}else x8(this,g.Ra(this.Zy,a,b))};
...
g.h.Vz=function(a,b){if(1==this.g){if(a&&b){var c=v8(this);q8(c,a,b);y8(this,c)}A8(this,"previous")}else x8(this,g.Ra(this.Vz,a,b))};
...
g.h.fH=function(a){if(!a)this.Zj(null),t8(this,null);else if(this.l.receiver.volume){a=this.l.receiver.volume;var b=v8(this),c=Math.round(100*a.level||0);if(b.volume!=c||b.muted!=a.muted)l7("CP","Cast volume update: "+a.level+(a.muted?" muted":"")),b.volume=c,b.muted=!!a.muted,y8(this,b)}};
g.h.Zj=function(a){l7("CP","Cast media: "+!!a);this.i&&this.i.removeUpdateListener(this.C);if(this.i=a)this.i.addUpdateListener(this.C),B8(this),this.N("remotePlayerChange")};
g.h.eH=function(a){a?(B8(this),this.N("remotePlayerChange")):this.Zj(null)};
g.h.rH=function(){var a=h8();a&&t8(this,a)};
...
g.h.bC=function(){this.Ch(2)};
g.h.jH=function(){E8("Channel opened");this.I&&(this.I=!1,H8(this),this.G=g.Co((0,g.x)(function(){E8("Timing out waiting for a screen.");this.Ch(1)},this),15E3));
Ypa(hqa(this.g),this.M)};
g.h.gH=function(){E8("Channel closed");isNaN(this.u)?G5(!0):G5();this.dispose()};
g.h.hH=function(a){G5();isNaN(this.lj())?(E8("Channel error: "+a+" without reconnection"),this.dispose()):(this.I=!0,E8("Channel error: "+a+" with reconnection in "+this.lj()+" ms"),F8(this,2))};
g.h.iH=function(a){a.params?E8("Received: action="+a.action+", params="+g.zj(a.params)):E8("Received: action="+a.action+" {}");switch(a.action){case "loungeStatus":a=Q5(a.params.devices);this.i=(0,g.fe)(a,function(c){return new o5(c)});
...
g.h.ZK=function(){if(this.l){var a=this.l;this.l=null;this.Na.videoId!=a&&J8(this,"getNowPlaying")}};
g.h.RB=function(){var a=3;this.fa()||(a=0,isNaN(this.lj())?d7(this.g)&&isNaN(this.u)&&(a=1):a=2);return a};
g.h.Ch=function(a){E8("Disconnecting with "+a);G8(this);this.N("beforeDisconnect",a);1==a&&G5();c7(this.g,a);this.dispose()};
g.h.QB=function(){var a=this.Na;this.l&&(a=this.Na.clone(),q8(a,this.l,a.index));return r8(a)};
g.h.mL=function(a){var b=new l8(a);b.videoId&&b.videoId!=this.Na.videoId&&(this.l=b.videoId,g.Eo(this.B),this.B=g.Co((0,g.x)(this.ZK,this),5E3));var c=[];this.Na.listId==b.listId&&this.Na.videoId==b.videoId&&this.Na.index==b.index||c.push("remoteQueueChange");this.Na.playerState==b.playerState&&this.Na.volume==b.volume&&this.Na.muted==b.muted&&p8(this.Na)==p8(b)&&g.zj(this.Na.g)==g.zj(b.g)||c.push("remotePlayerChange");this.Na.reset(a);(0,g.z)(c,function(d){this.N(d)},this)};
g.h.Nu=function(){var a=this.g.w.id,b=g.Ya(this.i,function(c){return"REMOTE_CONTROL"==c.type&&c.id!=a});
return b?b.id:""};
...
g.h.ZL=function(){if(!isNaN(this.lj())){var a=this.g.i;g.cn(a.g);a.start()}};
g.h.hL=function(a,b){J8(this,a,b);K8(this)};
D8.prototype.subscribe=D8.prototype.subscribe;D8.prototype.unsubscribeByKey=D8.prototype.Af;D8.prototype.getProxyState=D8.prototype.RB;D8.prototype.disconnect=D8.prototype.Ch;D8.prototype.getPlayerContextData=D8.prototype.QB;D8.prototype.setPlayerContextData=D8.prototype.mL;D8.prototype.getOtherConnectedRemoteId=D8.prototype.Nu;D8.prototype.getReconnectTimeout=D8.prototype.lj;D8.prototype.getAutoplayMode=D8.prototype.KB;D8.prototype.getAutoplayVideoId=D8.prototype.LB;D8.prototype.reconnect=D8.prototype.ZL;
D8.prototype.sendMessage=D8.prototype.hL;g.r(O8,p7);g.h=O8.prototype;g.h.Kd=function(a){return this.Sc.$_gs(a)};
...
g.h.In=function(a,b,c,d){this.Sc.$_un(a,b,c,d)};
...
g.h.dM=function(){this.N("screenChange")};
g.h.II=function(){this.N("onlineScreenChange")};
C7.prototype.$_st=C7.prototype.start;C7.prototype.$_gspc=C7.prototype.eM;C7.prototype.$_gsppc=C7.prototype.Yz;C7.prototype.$_c=C7.prototype.contains;C7.prototype.$_g=C7.prototype.get;C7.prototype.$_a=C7.prototype.add;C7.prototype.$_un=C7.prototype.In;C7.prototype.$_r=C7.prototype.remove;C7.prototype.$_gs=C7.prototype.Kd;C7.prototype.$_gos=C7.prototype.Xz;C7.prototype.$_s=C7.prototype.subscribe;C7.prototype.$_ubk=C7.prototype.Af;var h9=null,g9=!1,P8=null,Q8=null,f9=null,U8=[];g.r(i9,g.E);g.h=i9.prototype;
g.h.V=function(){g.E.prototype.V.call(this);this.o.stop();this.w.stop();this.I.stop();this.M();this.g.unsubscribe("proxyStateChange",this.Ux,this);this.g.unsubscribe("remotePlayerChange",this.bk,this);this.g.unsubscribe("remoteQueueChange",this.cn,this);this.g.unsubscribe("autoplayUpNext",this.wx,this);this.g.unsubscribe("previousNextChange",this.Rx,this);this.g.unsubscribe("nowAutoplaying",this.Nx,this);this.g.unsubscribe("autoplayDismissed",this.vx,this);this.g=this.u=null};
g.h.qw=function(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];if(2!=this.g.g)if(l9(this)){if(!v8(this.g).isAdPlaying()||"control_seek"!=a)switch(a){case "control_toggle_play_pause":1==v8(this.g).playerState?this.g.pause():this.g.play();break;case "control_play":this.g.play();break;case "control_pause":this.g.pause();break;case "control_seek":this.G.Ul(c[0],c[1]);break;case "control_subtitles_set_track":m9(this,c[0]);break;case "control_set_audio_track":c=c[0],l9(this)&&this.g.setAudioTrack(this.i.getVideoData(1).videoId,
...
g.h.dH=function(a){this.I.XB(a)};
g.h.IL=function(a){this.qw("control_subtitles_set_track",g.Zb(a)?null:a)};
g.h.kz=function(){var a=this.i.getOption("captions","track");g.Zb(a)||m9(this,a)};
g.h.Gx=function(a){if(l9(this)){this.g.unsubscribe("remotePlayerChange",this.bk,this);var b=Math.round(a.volume);a=!!a.muted;var c=v8(this.g);if(b!=c.volume||a!=c.muted)this.g.setVolume(b,a),this.R.start();this.g.subscribe("remotePlayerChange",this.bk,this)}};
g.h.dI=function(){g.Zb(this.B)||Rqa(this,this.B);this.C=!1};
g.h.Ux=function(a,b){this.w.stop();2==b&&this.jz()};
g.h.bk=function(){if(l9(this)){this.o.stop();var a=v8(this.g);switch(a.playerState){case 1080:case 1081:case 1084:case 1085:this.u.D=1;break;case 1082:case 1083:this.u.D=0;break;default:this.u.D=-1}switch(a.playerState){case 1081:case 1:k9(this,new g.Ct(8));this.iz();break;case 1085:case 3:k9(this,new g.Ct(9));break;case 1083:case 0:k9(this,new g.Ct(2));this.G.stop();j9(this,this.i.getVideoData().lengthSeconds);break;case 1084:k9(this,new g.Ct(4));break;case 2:k9(this,new g.Ct(4));j9(this,p8(a));
break;case -1:k9(this,new g.Ct(64));break;case -1E3:k9(this,new g.Ct(128,{errorCode:"mdx.remoteerror",errorMessage:"This video is not available for remote playback."}))}a=v8(this.g).g;var b=this.B;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&a.kind==b.kind:1)||(this.B=a,Rqa(this,a));a=v8(this.g);-1==a.volume||Math.round(this.i.getVolume())==a.volume&&this.i.isMuted()==a.muted||this.R.isActive()||this.Kz()}else Qqa(this)};
g.h.Rx=function(){this.i.N("mdxpreviousnextchange")};
g.h.cn=function(){l9(this)||Qqa(this)};
g.h.dB=function(){this.g.Xt()};
g.h.wx=function(a){a&&!g.P(this.i.L().experiments,"disable_legacy_desktop_remote_queue")&&(a=g.Ap("/watch_queue_ajax",{method:"GET",od:{action_get_watch_queue_item:1,video_id:a},onSuccess:(0,g.x)(this.kK,this)}))&&(this.M=(0,g.x)(a.abort,a))};
g.h.kK=function(a,b){var c=new g.LB(this.i.L(),{videoId:b.videoId,title:b.title,author:b.author,murlmq_webp:b.url});this.suggestion=c;this.i.N("mdxautoplayupnext",c)};
g.h.Nx=function(a){isNaN(a)||this.i.N("mdxnowautoplaying",a)};
g.h.vx=function(){this.i.N("mdxautoplaycanceled")};
g.h.AE=function(a,b){-1==v8(this.g).playerState?n9(this,a):b&&this.g.seekTo(a)};
g.h.Kz=function(){if(l9(this)){var a=v8(this.g);this.l.Sa(this.P);a.muted?this.i.mute():this.i.unMute();this.i.setVolume(a.volume);this.P=this.l.J(this.i,"onVolumeChange",this.Gx)}};
g.h.iz=function(){this.o.stop();if(!this.g.fa()){var a=v8(this.g);1==a.playerState&&k9(this,new g.Ct(8));j9(this,p8(a));this.o.start()}};
g.h.jz=function(){this.w.stop();this.o.stop();var a=this.g.o.getReconnectTimeout();2==this.g.g&&!isNaN(a)&&this.w.start()};g.r(o9,g.T);o9.prototype.o=function(){m5("mdx-privacy-popup-cancel");this.l.hide()};
...
g.h.create=function(){Lqa(g.Xy(this.player.L()));this.o.push(g.Jo("yt-remote-before-disconnect",this.aH,this));this.o.push(g.Jo("yt-remote-connection-change",this.nJ,this));this.o.push(g.Jo("yt-remote-receiver-availability-change",this.Sx,this));this.o.push(g.Jo("yt-remote-auto-connect",this.lJ,this));this.o.push(g.Jo("yt-remote-receiver-resumed",this.kJ,this));this.o.push(g.Jo("mdx-privacy-popup-confirm",this.PK,this));this.o.push(g.Jo("mdx-privacy-popup-cancel",this.OK,this));this.Sx()};
...
g.h.Mj=function(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];this.loaded&&this.u.qw.apply(this.u,[a].concat(g.ea(c)))};
...
g.h.oE=function(){this.g&&this.g.Vz()};
g.h.aH=function(a){1==a&&(this.M=this.g?v8(this.g):null)};
g.h.nJ=function(){var a=e9()?new u8($8(),void 0):null;if(a){var b=this.l;this.loaded&&this.unload();this.g=a;this.M=null;b.key!=this.i.key&&(this.l=b,this.load())}else g.Ci(this.g),this.g=null,this.loaded&&(this.unload(),(a=this.M)&&a.videoId==this.player.getVideoData().videoId&&this.player.cueVideoById(a.videoId,p8(a)));this.player.N("videodatachange","newdata",this.player.getVideoData(),3)};
g.h.Sx=function(){this.G=[this.i].concat(Mqa());var a=a9()||this.i;t9(this,a);this.player.ha("onMdxReceiversChange")};
g.h.GK=function(a){!this.I&&g.jD(a,8)&&(this.player.pauseVideo(),s9(this))};
g.h.lJ=function(){var a=a9();t9(this,a)};
g.h.kJ=function(){this.l=a9()};
g.h.PK=function(){this.I=!0;s9(this);g9=!1;h9&&c9(h9,1);h9=null};
g.h.OK=function(){this.I=!1;s9(this);t9(this,this.i);this.l=this.i;g9=!1;h9=null;this.player.playVideo()};
...
g.h.pE=function(){A8(this.g,"sendDebugCommand",{debugCommand:"stats4nerds "})};
