...
function Jb(a){var b=new ib(jb,Oa instanceof La&&Oa.constructor===La&&Oa.g===Na?Oa.f:"type_error:Const",null);a.src=b.f?b.f:lb(b).toString()}
...
m.set=function(a,b,c,d,e,f){if("object"===typeof c){var g=c.g;f=c.secure;e=c.domain;d=c.path;c=c.f}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');v(c)||(c=-1);e=e?";domain="+e:"";d=d?";path="+d:"";f=f?";secure":"";c=0>c?"":0==c?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(B()+1E3*c)).toUTCString();this.f.cookie=a+"="+b+e+d+c+f+(null!=g?";samesite="+g:"")};
...
function dc(a,b,c){var d=arguments,e=document,f=String(d[0]),g=d[1];if(!Yb&&g&&(g.name||g.type)){f=["<",f];g.name&&f.push(' name="',Mb(g.name),'"');if(g.type){f.push(' type="',Mb(g.type),'"');var h={};hb(h,g);delete h.type;g=h}f.push(">");f=f.join("")}f=ec(e,f);g&&(x(g)?f.className=g:Aa(g)?f.className=g.join(" "):bc(f,g));2<d.length&&fc(e,f,d);return f}
function fc(a,b,c){function d(g){g&&b.appendChild(x(g)?a.createTextNode(g):g)}
for(var e=2;e<c.length;e++){var f=c[e];!Ba(f)||Da(f)&&0<f.nodeType?d(f):F(gc(f)?Va(f):f,d)}}
...
;function ic(a){jc();return new ib(jb,a,null)}
var jc=xa;var kc=/^(?:([^:/?#.]+):)?(?:\/\/(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\?([^#]*))?(?:#([\s\S]*))?$/;function I(a){return a?decodeURI(a):a}
function J(a,b){return b.match(kc)[a]||null}
...
return a}
var rc={Ya:"allow-forms",Za:"allow-modals",ab:"allow-orientation-lock",bb:"allow-pointer-lock",cb:"allow-popups",eb:"allow-popups-to-escape-sandbox",fb:"allow-presentation",gb:"allow-same-origin",hb:"allow-scripts",ib:"allow-top-navigation",jb:"allow-top-navigation-by-user-activation"},tc=Xa(function(){return sc()});
function uc(){var a=ec(document,"IFRAME").sandbox,b=a&&a.supports;if(!b)return{};var c={};F(tc(),function(d){b.call(a,d)&&(c[d]=!0)});
return c}
...
function b(p){for(var w=g,r=0;64>r;r+=4)w[r/4]=p[r]<<24|p[r+1]<<16|p[r+2]<<8|p[r+3];for(r=16;80>r;r++)p=w[r-3]^w[r-8]^w[r-14]^w[r-16],w[r]=(p<<1|p>>>31)&4294967295;p=e[0];var G=e[1],W=e[2],pa=e[3],Bc=e[4];for(r=0;80>r;r++){if(40>r)if(20>r){var Ja=pa^G&(W^pa);var Kb=1518500249}else Ja=G^W^pa,Kb=1859775393;else 60>r?(Ja=G&W|pa&(G|W),Kb=2400959708):(Ja=G^W^pa,Kb=3395469782);Ja=((p<<5|p>>>27)&4294967295)+Ja+Bc+Kb+w[r]&4294967295;Bc=pa;pa=W;W=(G<<30|G>>>2)&4294967295;G=p;p=Ja}e[0]=e[0]+p&4294967295;e[1]=
e[1]+G&4294967295;e[2]=e[2]+W&4294967295;e[3]=e[3]+pa&4294967295;e[4]=e[4]+Bc&4294967295}
...
;function zc(a,b,c){var d=[],e=[];if(1==(Aa(c)?2:1))return e=[b,a],F(d,function(h){e.push(h)}),Ac(e.join(" "));
...
;function Fc(a){u.setTimeout(function(){throw a;},0)}
var Gc;
function Hc(){var a=u.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&-1==Ab.indexOf("Presto")&&(a=function(){var e=ec(document,"IFRAME");e.style.display="none";Jb(e);document.documentElement.appendChild(e);var f=e.contentWindow;e=f.document;e.open();e.write(Fb(Hb));e.close();var g="callImmediate"+Math.random(),h="file:"==f.location.protocol?"*":f.location.protocol+"//"+f.location.host;e=A(function(k){if(("*"==h||k.origin==h)&&k.data==
...
var Mc;function Nc(){if(u.Promise&&u.Promise.resolve){var a=u.Promise.resolve(void 0);Mc=function(){a.then(Qc)}}else Mc=function(){var b=Qc;
!Ca(u.setImmediate)||u.Window&&u.Window.prototype&&-1==Ab.indexOf("Edge")&&u.Window.prototype.setImmediate==u.setImmediate?(Gc||(Gc=Hc()),Gc(b)):u.setImmediate(b)}}
...
C(Sc,Rc);Sc.prototype.reset=function(){this.f[0]=1732584193;this.f[1]=4023233417;this.f[2]=2562383102;this.f[3]=271733878;this.f[4]=3285377520;this.j=this.h=0};
function Tc(a,b,c){c||(c=0);var d=a.A;if(x(b))for(var e=0;16>e;e++)d[e]=b.charCodeAt(c)<<24|b.charCodeAt(c+1)<<16|b.charCodeAt(c+2)<<8|b.charCodeAt(c+3),c+=4;else for(e=0;16>e;e++)d[e]=b[c]<<24|b[c+1]<<16|b[c+2]<<8|b[c+3],c+=4;for(e=16;80>e;e++){var f=d[e-3]^d[e-8]^d[e-14]^d[e-16];d[e]=(f<<1|f>>>31)&4294967295}b=a.f[0];c=a.f[1];var g=a.f[2],h=a.f[3],k=a.f[4];for(e=0;80>e;e++){if(40>e)if(20>e){f=h^c&(g^h);var l=1518500249}else f=c^g^h,l=1859775393;else 60>e?(f=c&g|h&(c|g),l=2400959708):(f=c^g^h,l=
...
Sc.prototype.update=function(a,b){if(null!=a){v(b)||(b=a.length);for(var c=b-this.g,d=0,e=this.l,f=this.h;d<b;){if(0==f)for(;d<=c;)Tc(this,a,d),d+=this.g;if(x(a))for(;d<b;){if(e[f]=a.charCodeAt(d),++f,++d,f==this.g){Tc(this,e);f=0;break}}else for(;d<b;)if(e[f]=a[d],++f,++d,f==this.g){Tc(this,e);f=0;break}}this.h=f;this.j+=b}};
Sc.prototype.digest=function(){var a=[],b=8*this.j;56>this.h?this.update(this.i,56-this.h):this.update(this.i,this.g-(this.h-56));for(var c=this.g-1;56<=c;c--)this.l[c]=b&255,b/=256;Tc(this,this.l);for(c=b=0;5>c;c++)for(var d=24;0<=d;d-=8)a[b]=this.f[c]>>d&255,++b;return a};function K(){this.g=this.g;this.A=this.A}
K.prototype.g=!1;K.prototype.dispose=function(){this.g||(this.g=!0,this.m())};
function Uc(a,b){a.g?v(void 0)?b.call(void 0):b():(a.A||(a.A=[]),a.A.push(v(void 0)?A(b,void 0):b))}
K.prototype.m=function(){if(this.A)for(;this.A.length;)this.A.shift()()};
function Vc(a){a&&"function"==typeof a.dispose&&a.dispose()}
function Wc(a){for(var b=0,c=arguments.length;b<c;++b){var d=arguments[b];Ba(d)?Wc.apply(null,d):Vc(d)}}
;function Xc(a){if(a.classList)return a.classList;a=a.className;return x(a)&&a.match(/\S+/g)||[]}
function Yc(a,b){if(a.classList)var c=a.classList.contains(b);else c=Xc(a),c=0<=Pa(c,b);return c}
function Zc(){var a=document.body;a.classList?a.classList.remove("inverted-hdpi"):Yc(a,"inverted-hdpi")&&(a.className=Qa(Xc(a),function(b){return"inverted-hdpi"!=b}).join(" "))}
;var $c="StopIteration"in u?u.StopIteration:{message:"StopIteration",stack:""};function ad(){}
...
function dd(a){if(Ba(a))return Va(a);a=bd(a);var b=[];cd(a,function(c){b.push(c)});
return b}
...
var rd=new Dc(function(){return new qd},function(a){a.reset()});
function sd(a,b,c){var d=rd.get();d.g=a;d.onRejected=b;d.context=c;return d}
function td(a){return new L(function(b,c){c(a)})}
L.prototype.then=function(a,b,c){return ud(this,Ca(a)?a:null,Ca(b)?b:null,c)};
L.prototype.$goog_Thenable=!0;function vd(a,b){return ud(a,null,b,void 0)}
L.prototype.cancel=function(a){0==this.f&&Lc(function(){var b=new wd(a);xd(this,b)},this)};
...
function zd(a,b,c,d){if(3==c&&b.onRejected&&!b.h)for(;a&&a.j;a=a.h)a.j=!1;if(b.f)b.f.h=null,Ed(b,c,d);else try{b.h?b.g.call(b.context):Ed(b,c,d)}catch(e){Fd.call(null,e)}Ec(rd,b)}
function Ed(a,b,c){2==b?a.g.call(a.context,c):a.onRejected&&a.onRejected.call(a.context,c)}
function Dd(a,b){a.j=!0;Lc(function(){a.j&&Fd.call(null,b)})}
var Fd=Fc;function wd(a){E.call(this,a)}
C(wd,E);wd.prototype.name="cancel";function M(a){K.call(this);this.l=1;this.i=[];this.j=0;this.f=[];this.h={};this.o=!!a}
...
function Gd(a,b,c,d){if(b=a.h[b]){var e=a.f;(b=Ta(b,function(f){return e[f+1]==c&&e[f+2]==d}))&&a.N(b)}}
...
Id.prototype.set=function(a,b){v(b)?this.f.set(a,id(b)):this.f.remove(a)};
...
function Ld(a){return!v(a)||a instanceof Kd?a:new Kd(a)}
Jd.prototype.set=function(a,b){Jd.L.set.call(this,a,Ld(b))};
Jd.prototype.g=function(a){a=Jd.L.get.call(this,a);if(!v(a)||a instanceof Object)return a;throw"Storage: Invalid value was encountered";};
Jd.prototype.get=function(a){if(a=this.g(a)){if(a=a.data,!v(a))throw"Storage: Invalid value was encountered";}else a=void 0;return a};function Md(a){this.f=a}
...
m.D=function(a){var b=0,c=this.f,d=new ad;d.next=function(){if(b>=c.length)throw $c;var e=c.key(b++);if(a)return e;e=c.getItem(e);if(!x(e))throw"Storage mechanism: Invalid value was encountered";return e};
return d};
...
C(Qd,Pd);function Rd(a,b){this.g=a;this.f=null;if(Ob&&!(9<=Number(Pb))){Sd||(Sd=new ed);this.f=Sd.get(a);this.f||(b?this.f=document.getElementById(b):(this.f=document.createElement("userdata"),this.f.addBehavior("#default#userData"),document.body.appendChild(this.f)),Sd.set(a,this.f));try{this.f.load(this.g)}catch(c){this.f=null}}}
...
m.get=function(a){a=this.f.getAttribute(Ud(a));if(!x(a)&&null!==a)throw"Storage mechanism: Invalid value was encountered";return a};
m.remove=function(a){this.f.removeAttribute(Ud(a));Vd(this)};
m.D=function(a){var b=0,c=this.f.XMLDocument.documentElement.attributes,d=new ad;d.next=function(){if(b>=c.length)throw $c;var e=c[b++];if(a)return decodeURIComponent(e.nodeName.replace(/\./g,"%")).substr(1);e=e.nodeValue;if(!x(e))throw"Storage mechanism: Invalid value was encountered";return e};
return d};
...
function Yd(a){-1==a.f&&(a.f=Sa(a.g,function(b,c,d){return c?b+Math.pow(2,d):b},0));
return a.f}
;function Zd(a,b){1<b.length?a[b[0]]=b[1]:1===b.length&&Object.assign(a,b[0])}
;var $d=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};y("yt.config_",$d,void 0);function N(a){Zd($d,arguments)}
function O(a,b){return a in $d?$d[a]:b}
function ae(a){return O(a,void 0)}
function be(){return O("PLAYER_CONFIG",{})}
...
;function fe(a){return a&&window.yterr?function(){try{return a.apply(this,arguments)}catch(b){P(b)}}:a}
function P(a,b,c,d,e){var f=z("yt.logging.errors.log");f?f(a,b,c,d,e):(f=O("ERRORS",[]),f.push([a,b,c,d,e]),N("ERRORS",f))}
function ge(a){P(a,"WARNING",void 0,void 0,void 0)}
;function he(a){var b=[];Ya(a,function(c,d){var e=encodeURIComponent(String(d)),f;Aa(c)?f=c:f=[c];F(f,function(g){""==g?b.push(e):b.push(e+"="+encodeURIComponent(String(g)))})});
return b.join("&")}
function ie(a){"?"==a.charAt(0)&&(a=a.substr(1));a=a.split("&");for(var b={},c=0,d=a.length;c<d;c++){var e=a[c].split("=");if(1==e.length&&e[0]||2==e.length)try{var f=decodeURIComponent((e[0]||"").replace(/\+/g," ")),g=decodeURIComponent((e[1]||"").replace(/\+/g," "));f in b?Aa(b[f])?Wa(b[f],g):b[f]=[b[f],g]:b[f]=g}catch(k){var h=Error("Error decoding URL component");h.params="key: "+e[0]+", value: "+e[1];"q"==e[0]?ge(h):P(h)}}return b}
function je(a,b){return ke(a,b||{},!0)}
function ke(a,b,c){var d=a.split("#",2);a=d[0];d=1<d.length?"#"+d[1]:"";var e=a.split("?",2);a=e[0];e=ie(e[1]||"");for(var f in b)!c&&null!==e&&f in e||(e[f]=b[f]);return nc(a,e)+d}
;function le(a){var b=me;a=void 0===a?z("yt.ads.biscotti.lastId_")||"":a;b=Object.assign(ne(b),oe(b));b.ca_type="image";a&&(b.bid=a);return b}
function ne(a){var b={};b.dt=wc;b.flash="0";a:{try{var c=a.f.top.location.href}catch(f){a=2;break a}a=c?c===a.g.location.href?0:1:2}b=(b.frm=a,b);b.u_tz=-(new Date).getTimezoneOffset();var d=void 0===d?D:d;try{var e=d.history.length}catch(f){e=0}b.u_his=e;b.u_java=!!D.navigator&&"unknown"!==typeof D.navigator.javaEnabled&&!!D.navigator.javaEnabled&&D.navigator.javaEnabled();D.screen&&(b.u_h=D.screen.height,b.u_w=D.screen.width,b.u_ah=D.screen.availHeight,b.u_aw=D.screen.availWidth,b.u_cd=D.screen.colorDepth);
...
function oe(a){var b=a.f;try{var c=b.screenX;var d=b.screenY}catch(p){}try{var e=b.outerWidth;var f=b.outerHeight}catch(p){}try{var g=b.innerWidth;var h=b.innerHeight}catch(p){}b=[b.screenLeft,b.screenTop,c,d,b.screen?b.screen.availWidth:void 0,b.screen?b.screen.availTop:void 0,e,f,g,h];c=a.f.top;try{var k=(c||window).document,l="CSS1Compat"==k.compatMode?k.documentElement:k.body;var n=(new $b(l.clientWidth,l.clientHeight)).round()}catch(p){n=new $b(-12245933,-12245933)}k=n;n={};l=new Xd;u.SVGElement&&
u.document.createElementNS&&l.set(0);c=uc();c["allow-top-navigation-by-user-activation"]&&l.set(1);c["allow-popups-to-escape-sandbox"]&&l.set(2);u.crypto&&u.crypto.subtle&&l.set(3);u.TextDecoder&&u.TextEncoder&&l.set(4);l=Yd(l);n.bc=l;n.bih=k.height;n.biw=k.width;n.brdim=b.join();a=a.g;return n.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[a.visibilityState||a.webkitVisibilityState||a.mozVisibilityState||""]||0,n.wgl=!!D.WebGLRenderingContext,n}
var me=new function(){var a=window.document;this.f=window;this.g=a};
y("yt.ads_.signals_.getAdSignalsString",function(a){return he(le(a))},void 0);B();function Q(a){a=pe(a);return x(a)&&"false"===a?!1:!!a}
function qe(a,b){var c=pe(a);return void 0===c&&void 0!==b?b:Number(c||0)}
function pe(a){var b=O("EXPERIMENTS_FORCED_FLAGS",{});return void 0!==b[a]?b[a]:O("EXPERIMENT_FLAGS",{})[a]}
;var re=v(XMLHttpRequest)?function(){return new XMLHttpRequest}:v(ActiveXObject)?function(){return new ActiveXObject("Microsoft.XMLHTTP")}:null;
...
;function R(a,b){Ca(a)&&(a=fe(a));return window.setTimeout(a,b)}
function S(a){window.clearTimeout(a)}
;var ue={Authorization:"AUTHORIZATION","X-Goog-Visitor-Id":"SANDBOXED_VISITOR_ID","X-YouTube-Client-Name":"INNERTUBE_CONTEXT_CLIENT_NAME","X-YouTube-Client-Version":"INNERTUBE_CONTEXT_CLIENT_VERSION","X-Youtube-Identity-Token":"ID_TOKEN","X-YouTube-Page-CL":"PAGE_CL","X-YouTube-Page-Label":"PAGE_BUILD_LABEL","X-YouTube-Variants-Checksum":"VARIANTS_CHECKSUM"},ve="app debugcss debugjs expflag force_ad_params force_viral_ad_response_params forced_experiments internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address".split(" "),
we=!1;
function xe(a,b){b=void 0===b?{}:b;if(!c)var c=window.location.href;var d=J(1,a),e=I(J(3,a));d&&e?(d=c,c=a.match(kc),d=d.match(kc),c=c[3]==d[3]&&c[1]==d[1]&&c[4]==d[4]):c=e?I(J(3,c))==e&&(Number(J(4,c))||null)==(Number(J(4,a))||null):!0;d=Q("web_ajax_ignore_global_headers_if_set");for(var f in ue)e=O(ue[f]),!e||!c&&!ye(a,f)||d&&void 0!==b[f]||(b[f]=e);if(c||ye(a,"X-YouTube-Utc-Offset"))b["X-YouTube-Utc-Offset"]=String(-(new Date).getTimezoneOffset());(Q("pass_biscotti_id_in_header_ajax")||Q("pass_biscotti_id_in_header_ajax_tv"))&&(c||
ye(a,"X-YouTube-Ad-Signals"))&&(b["X-YouTube-Ad-Signals"]=he(le(void 0)));return b}
function ze(a){var b=window.location.search,c=I(J(3,a)),d=I(J(5,a));d=(c=c&&(c.endsWith("youtube.com")||c.endsWith("youtube-nocookie.com")))&&d&&d.startsWith("/api/");if(!c||d)return a;var e=ie(b),f={};F(ve,function(g){e[g]&&(f[g]=e[g])});
return ke(a,f||{},!1)}
function ye(a,b){var c=O("CORS_HEADER_WHITELIST")||{},d=I(J(3,a));return d?(c=c[d])?0<=Pa(c,b):!1:!0}
...
b.na&&0<b.timeout&&(f=R(function(){e||(e=!0,S(f),b.na.call(b.context||u))},b.timeout))}else De(a,b)}
function De(a,b){var c=b.format||"JSON";a=Be(a,b);var d=Ce(a,b),e=!1,f,g=Ee(a,function(h){if(!e){e=!0;f&&S(f);var k=te(h),l=null,n=400<=h.status&&500>h.status,p=500<=h.status&&600>h.status;if(k||n||p)l=Fe(c,h,b.nb);if(k)a:if(h&&204==h.status)k=!0;else{switch(c){case "XML":k=0==parseInt(l&&l.return_code,10);break a;case "RAW":k=!0;break a}k=!!l}l=l||{};n=b.context||u;k?b.onSuccess&&b.onSuccess.call(n,h,l):b.onError&&b.onError.call(n,h,l);b.ia&&b.ia.call(n,h,l)}},b.method,d,b.headers,b.responseType,
b.withCredentials);
b.O&&0<b.timeout&&(f=R(function(){e||(e=!0,g.abort(),S(f),b.O.call(b.context||u,g))},b.timeout));
return g}
function Be(a,b){b.qb&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=O("XSRF_FIELD_NAME",void 0),d=b.Xa;d&&(d[c]&&delete d[c],a=je(a,d));return a}
function Ce(a,b){var c=O("XSRF_FIELD_NAME",void 0),d=O("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.C,g=ae("XSRF_FIELD_NAME"),h;b.headers&&(h=b.headers["Content-Type"]);b.pb||I(J(3,a))&&!b.withCredentials&&I(J(3,a))!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.C&&b.C[g]||(f||(f={}),f[c]=d);f&&x(e)&&(e=ie(e),hb(e,f),e=b.oa&&"JSON"==b.oa?JSON.stringify(e):mc(e));f=e||f&&!bb(f);!we&&f&&"POST"!=b.method&&(we=!0,P(Error("AJAX request with postData should use POST")));
return e}
function Fe(a,b,c){var d=null;switch(a){case "JSON":a=b.responseText;b=b.getResponseHeader("Content-Type")||"";a&&0<=b.indexOf("json")&&(d=JSON.parse(a));break;case "XML":if(b=(b=b.responseXML)?Ge(b):null)d={},F(b.getElementsByTagName("*"),function(e){d[e.tagName]=He(e)})}c&&Ie(d);
return d}
function Ie(a){if(Da(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d=Gb(a[b],null);a[c]=d}else Ie(a[b])}}
function Ge(a){return a?(a=("responseXML"in a?a.responseXML:a).getElementsByTagName("root"))&&0<a.length?a[0]:null:null}
function He(a){var b="";F(a.childNodes,function(c){b+=c.nodeValue});
return b}
function Ee(a,b,c,d,e,f,g){function h(){4==(k&&"readyState"in k?k.readyState:0)&&b&&fe(b)(k)}
c=void 0===c?"GET":c;d=void 0===d?"":d;var k=se();if(!k)return null;"onloadend"in k?k.addEventListener("loadend",h,!1):k.onreadystatechange=h;Q("debug_forward_web_query_parameters")&&(a=ze(a));k.open(c,a,!0);f&&(k.responseType=f);g&&(k.withCredentials=!0);c="POST"==c&&(void 0===window.FormData||!(d instanceof FormData));if(e=xe(a,e))for(var l in e)k.setRequestHeader(l,e[l]),"content-type"==l.toLowerCase()&&(c=!1);c&&k.setRequestHeader("Content-Type","application/x-www-form-urlencoded");k.send(d);
return k}
;var Je={},Ke=0;
function Le(a,b,c,d,e){e=void 0===e?"":e;a&&(c&&(c=Ab,c=!(c&&0<=c.toLowerCase().indexOf("cobalt"))),c?a&&(a instanceof H||(a="object"==typeof a&&a.J?a.I():String(a),yb.test(a)||(a="about:invalid#zClosurez"),a=new H(vb,a)),b=xb(a).toString(),"about:invalid#zClosurez"===b?a="":(b instanceof Db?a=b:(d="object"==typeof b,a=null,d&&b.ga&&(a=b.da()),b=nb(d&&b.J?b.I():String(b)),a=Gb(b,a)),a=Fb(a).toString(),a=encodeURIComponent(String(id(a)))),/^[\s\xa0]*$/.test(a)||(a=dc("IFRAME",{src:'javascript:"<body><img src=\\""+'+a+
'+"\\"></body>"',style:"display:none"}),(9==a.nodeType?a:a.ownerDocument||a.document).body.appendChild(a))):e?Ee(a,b,"POST",e,d):O("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)||d?Ee(a,b,"GET","",d):Me(a,b)||Ne(a,b))}
function Me(a,b){var c=$d.EXPERIMENT_FLAGS;if(!c||!c.web_use_beacon_api_for_ad_click_server_pings)return!1;c=I(J(5,a));return c&&-1!=c.indexOf("/aclk")&&"1"===pc(a,"ae")&&"1"===pc(a,"act")?Oe(a)?(b&&b(),!0):!1:!1}
function Oe(a,b){try{if(window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,void 0===b?"":b))return!0}catch(c){}return!1}
function Ne(a,b){var c=new Image,d=""+Ke++;Je[d]=c;c.onload=c.onerror=function(){b&&Je[d]&&b();delete Je[d]};
c.src=a}
;var Pe={},Qe=0;
function Re(a,b,c,d,e,f){f=f||{};f.name=c||O("INNERTUBE_CONTEXT_CLIENT_NAME",1);f.version=d||O("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0);b=void 0===b?"ERROR":b;e=void 0===e?!1:e;b=void 0===b?"ERROR":b;e=window&&window.yterr||(void 0===e?!1:e)||!1;if(!(!a||!e||5<=Qe||(Q("console_log_js_exceptions")&&(e=a,c=[],c.push("Name: "+e.name),c.push("Message: "+e.message),e.hasOwnProperty("params")&&c.push("Error Params: "+JSON.stringify(e.params)),c.push("File name: "+e.fileName),c.push("Stacktrace: "+e.stack),
window.console.log(c.join("\n"),e)),e=a.stacktrace,c=a.columnNumber,a.hasOwnProperty("params")&&(d=String(JSON.stringify(a.params)),f.params=d.substr(0,500)),a=Wb(a),e=e||a.stack,d=a.lineNumber.toString(),isNaN(d)||isNaN(c)||(d=d+":"+c),window.yterr&&Ca(window.yterr)&&window.yterr(a),Pe[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js")))){b={Xa:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,250),line:d,level:b,"client.name":f.name},C:{url:O("PAGE_NAME",window.location.href),
file:a.fileName},method:"POST"};f.version&&(b["client.version"]=f.version);e&&(b.C.stack=e);for(var g in f)b.C["client."+g]=f[g];if(g=O("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(var h in g)b.C[h]=g[h];De(O("ECATCHER_REPORT_HOST","")+"/error_204",b);Pe[a.message]=!0;Qe++}}
;var Se=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};y("yt.msgs_",Se,void 0);function Te(a){Zd(Se,arguments)}
;function Ue(a){a&&(a.dataset?a.dataset[Ve("loaded")]="true":a.setAttribute("data-loaded","true"))}
function We(a,b){return a?a.dataset?a.dataset[Ve(b)]:a.getAttribute("data-"+b):null}
var Xe={};function Ve(a){return Xe[a]||(Xe[a]=String(a).replace(/\-([a-z])/g,function(b,c){return c.toUpperCase()}))}
;var Ye=z("ytPubsubPubsubInstance")||new M;M.prototype.subscribe=M.prototype.subscribe;M.prototype.unsubscribeByKey=M.prototype.N;M.prototype.publish=M.prototype.M;M.prototype.clear=M.prototype.clear;y("ytPubsubPubsubInstance",Ye,void 0);var Ze=z("ytPubsubPubsubSubscribedKeys")||{};y("ytPubsubPubsubSubscribedKeys",Ze,void 0);var $e=z("ytPubsubPubsubTopicToKeys")||{};y("ytPubsubPubsubTopicToKeys",$e,void 0);var af=z("ytPubsubPubsubIsSynchronous")||{};y("ytPubsubPubsubIsSynchronous",af,void 0);
function bf(a,b){var c=cf();if(c){var d=c.subscribe(a,function(){var e=arguments;var f=function(){Ze[d]&&b.apply(window,e)};
try{af[a]?f():R(f,0)}catch(g){P(g)}},void 0);
Ze[d]=!0;$e[a]||($e[a]=[]);$e[a].push(d);return d}return 0}
function df(a){var b=cf();b&&("number"==typeof a?a=[a]:x(a)&&(a=[parseInt(a,10)]),F(a,function(c){b.unsubscribeByKey(c);delete Ze[c]}))}
function ef(a,b){var c=cf();c&&c.publish.apply(c,arguments)}
function ff(a){var b=cf();if(b)if(b.clear(a),a)gf(a);else for(var c in $e)gf(c)}
function cf(){return z("ytPubsubPubsubInstance")}
function gf(a){$e[a]&&(a=$e[a],F(a,function(b){Ze[b]&&delete Ze[b]}),a.length=0)}
;var hf=/\.vflset|-vfl[a-zA-Z0-9_+=-]+/,jf=/-[a-zA-Z]{2,3}_[a-zA-Z]{2,3}(?=(\/|$))/;function kf(a,b,c){c=void 0===c?null:c;if(window.spf){c="";if(a){var d=a.indexOf("jsbin/"),e=a.lastIndexOf(".js"),f=d+6;-1<d&&-1<e&&e>f&&(c=a.substring(f,e),c=c.replace(hf,""),c=c.replace(jf,""),c=c.replace("debug-",""),c=c.replace("tracing-",""))}spf.script.load(a,c,b)}else lf(a,b,c)}
function lf(a,b,c){c=void 0===c?null:c;var d=mf(a),e=document.getElementById(d),f=e&&We(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=bf(d,b),b=""+(b[Ea]||(b[Ea]=++Fa)),nf[b]=f),g||(e=of(a,d,function(){We(e,"loaded")||(Ue(e),ef(d),R(Ia(ff,d),0))},c)))}
function of(a,b,c,d){d=void 0===d?null:d;var e=ec(document,"SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
function pf(a){a=mf(a);var b=document.getElementById(a);b&&(ff(a),b.parentNode.removeChild(b))}
function qf(a,b){if(a&&b){var c=""+(b[Ea]||(b[Ea]=++Fa));(c=nf[c])&&df(c)}}
function mf(a){var b=document.createElement("a");Ib(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+Nb(a)}
var nf={};function rf(){}
function sf(a,b){return tf(a,1,b)}
;function uf(){}
t(uf,rf);function tf(a,b,c){isNaN(c)&&(c=void 0);var d=z("yt.scheduler.instance.addJob");return d?d(a,b,c):void 0===c?(a(),NaN):R(a,c||0)}
function vf(a){if(!isNaN(a)){var b=z("yt.scheduler.instance.cancelJob");b?b(a):S(a)}}
uf.prototype.start=function(){var a=z("yt.scheduler.instance.start");a&&a()};
uf.prototype.pause=function(){var a=z("yt.scheduler.instance.pause");a&&a()};
ya(uf);uf.getInstance();var wf=[],xf=!1;function yf(){if("1"!=Za(be(),"args","privembed")){var a=function(){xf=!0;"google_ad_status"in window?N("DCLKSTAT",1):N("DCLKSTAT",2)};
kf("//static.doubleclick.net/instream/ad_status.js",a);wf.push(sf(function(){xf||"google_ad_status"in window||(qf("//static.doubleclick.net/instream/ad_status.js",a),xf=!0,N("DCLKSTAT",3))},5E3))}}
function zf(){return parseInt(O("DCLKSTAT",0),10)}
;function Af(){this.g=!1;this.f=null}
Af.prototype.initialize=function(a,b,c,d,e){var f=this;b?(this.g=!0,kf(b,function(){f.g=!1;if(window.botguard)Bf(f,c,d);else{pf(b);var g=Error("Unable to load Botguard");g.params="from "+b;ge(g)}},e)):a&&(eval(a),window.botguard?Bf(this,c,d):ge(Error("Unable to load Botguard from JS")))};
function Bf(a,b,c){try{a.f=new window.botguard.bg(b)}catch(d){ge(d)}c&&c(b)}
Af.prototype.dispose=function(){this.f=null};var Cf=window,T=Cf.ytcsi&&Cf.ytcsi.now?Cf.ytcsi.now:Cf.performance&&Cf.performance.timing&&Cf.performance.now?function(){return Cf.performance.timing.navigationStart+Cf.performance.now()}:function(){return(new Date).getTime()};var Df=new Af,Ef=!1,Ff=0,Gf="";function Hf(a){Q("botguard_periodic_refresh")?Ff=T():Q("botguard_always_refresh")&&(Gf=a)}
function If(a){if(a){if(Df.g)return!1;if(Q("botguard_periodic_refresh"))return 72E5<T()-Ff;if(Q("botguard_always_refresh"))return Gf!=a}else return!1;return!Ef}
...
Nf.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var ab=z("ytEventsEventsListeners")||{};y("ytEventsEventsListeners",ab,void 0);var Pf=z("ytEventsEventsCounter")||{count:0};y("ytEventsEventsCounter",Pf,void 0);
...
var Rf=Xa(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
window.addEventListener("test",null,b)}catch(c){}return a});
function U(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=Qf(a,b,c,d);if(e)return e;e=++Pf.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(h){h=new Nf(h);if(!hc(h.relatedTarget,function(k){return k==a}))return h.currentTarget=a,h.type=b,c.call(a,h)}:function(h){h=new Nf(h);
h.currentTarget=a;return c.call(a,h)};
g=fe(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),Rf()||"boolean"==typeof d?a.addEventListener(b,g,d):a.addEventListener(b,g,!!d.capture)):a.attachEvent("on"+b,g);ab[e]=[a,b,c,g,d];return e}
function Sf(a){a&&("string"==typeof a&&(a=[a]),F(a,function(b){if(b in ab){var c=ab[b],d=c[0],e=c[1],f=c[3];c=c[4];d.removeEventListener?Rf()||"boolean"==typeof c?d.removeEventListener(e,f,c):d.removeEventListener(e,f,!!c.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete ab[b]}}))}
;var Tf=window.ytcsi&&window.ytcsi.now?window.ytcsi.now:window.performance&&window.performance.timing&&window.performance.now&&window.performance.timing.navigationStart?function(){return window.performance.timing.navigationStart+window.performance.now()}:function(){return(new Date).getTime()};function Uf(a){this.w=a;this.f=null;this.j=0;this.o=null;this.l=0;this.h=[];for(a=0;4>a;a++)this.h.push(0);this.i=0;this.G=U(window,"mousemove",A(this.H,this));a=A(this.B,this);Ca(a)&&(a=fe(a));this.K=window.setInterval(a,25)}
C(Uf,K);Uf.prototype.H=function(a){v(a.f)||Of(a);var b=a.f;v(a.g)||Of(a);this.f=new Zb(b,a.g)};
...
function Wf(a){var b=void 0===a?{}:a;a=void 0===b.Aa?!0:b.Aa;b=void 0===b.Ma?!1:b.Ma;if(null==z("_lact",window)){var c=parseInt(O("LACT"),10);c=isFinite(c)?B()-Math.max(c,0):-1;y("_lact",c,window);y("_fact",c,window);-1==c&&Xf();U(document,"keydown",Xf);U(document,"keyup",Xf);U(document,"mousedown",Xf);U(document,"mouseup",Xf);a&&(b?U(window,"touchmove",function(){Yf("touchmove",200)},{passive:!0}):(U(window,"resize",function(){Yf("resize",200)}),U(window,"scroll",function(){Yf("scroll",200)})));
new Uf(function(){Yf("mouse",100)});
U(document,"touchstart",Xf,{passive:!0});U(document,"touchend",Xf,{passive:!0})}}
function Yf(a,b){Vf[a]||(Vf[a]=!0,sf(function(){Xf();Vf[a]=!1},b))}
function Xf(){null==z("_lact",window)&&Wf();var a=B();y("_lact",a,window);-1==z("_fact",window)&&y("_fact",a,window);(a=z("ytglobal.ytUtilActivityCallback_"))&&a()}
function Zf(){var a=z("_lact",window);return null==a?-1:Math.max(B()-a,0)}
;var $f=Math.pow(2,16)-1,ag=null,bg=0,cg={log_event:"events",log_interaction:"interactions"},dg=Object.create(null);dg.log_event="GENERIC_EVENT_LOGGING";dg.log_interaction="INTERACTION_LOGGING";var eg=new Set(["log_event"]),fg={},gg=0,hg=0,V=z("ytLoggingTransportLogPayloadsQueue_")||{};y("ytLoggingTransportLogPayloadsQueue_",V,void 0);var ig=z("ytLoggingTransportTokensToCttTargetIds_")||{};y("ytLoggingTransportTokensToCttTargetIds_",ig,void 0);var jg=z("ytLoggingTransportDispatchedStats_")||{};
y("ytLoggingTransportDispatchedStats_",jg,void 0);y("ytytLoggingTransportCapturedTime_",z("ytLoggingTransportCapturedTime_")||{},void 0);function kg(){S(gg);S(hg);hg=0;if(!bb(V)){for(var a in V){var b=fg[a];b&&(lg(a,b),delete V[a])}bb(V)||mg()}}
function mg(){Q("web_gel_timeout_cap")&&!hg&&(hg=R(kg,6E4));S(gg);gg=R(kg,O("LOGGING_BATCH_TIMEOUT",qe("web_gel_debounce_ms",1E4)))}
function ng(a,b){b=void 0===b?"":b;V[a]=V[a]||{};V[a][b]=V[a][b]||[];return V[a][b]}
function lg(a,b){var c=cg[a],d=jg[a]||{};jg[a]=d;var e=Math.round(T());for(l in V[a]){var f=fb,g=b.f;g={client:{hl:g.Ea,gl:g.Da,clientName:g.Ca,clientVersion:g.innertubeContextClientVersion,configInfo:g.Ba}};var h=window.devicePixelRatio;h&&1!=h&&(g.client.screenDensityFloat=String(h));O("DELEGATED_SESSION_ID")&&!Q("pageid_as_header_web")&&(g.user={onBehalfOfUser:O("DELEGATED_SESSION_ID")});f=f({context:g});f[c]=ng(a,l);d.dispatchedEventCount=d.dispatchedEventCount||0;d.dispatchedEventCount+=f[c].length;
if(g=ig[l])a:{var k=l;if(g.videoId)h="VIDEO";else if(g.playlistId)h="PLAYLIST";else break a;f.credentialTransferTokenTargetId=g;f.context=f.context||{};f.context.user=f.context.user||{};f.context.user.credentialTransferTokens=[{token:k,scope:h}]}delete ig[l];f.requestTimeMs=e;if(g=ae("EVENT_ID"))h=(O("BATCH_CLIENT_COUNTER",void 0)||0)+1,h>$f&&(h=1),N("BATCH_CLIENT_COUNTER",h),g={serializedEventId:g,clientCounter:h},f.serializedClientEventId=g,ag&&bg&&Q("log_gel_rtt_web")&&(f.previousBatchInfo={serializedClientEventId:ag,
...
function rg(a,b,c,d){d=void 0===d?{}:d;var e={};e.eventTimeMs=Math.round(d.timestamp||T());e[a]=b;e.context={lastActivityMs:String(d.timestamp?-1:Zf())};Q("log_sequence_info_on_gel_web")&&d.P&&(a=e.context,b=d.P,qg[b]=b in qg?qg[b]+1:0,a.sequence={index:qg[b],groupKey:b},d.ob&&delete qg[d.P]);(d=d.ca)?(a={},d.videoId?a.videoId=d.videoId:d.playlistId&&(a.playlistId=d.playlistId),ig[d.token]=a,d=ng("log_event",d.token)):d=ng("log_event");d.push(e);c&&(fg.log_event=new c);d.length>=(qe("web_logging_max_batch")||
100)?kg():mg()}
...
Va(k.args))}catch(p){throw p.message="yt.pubsub2.Data.deserialize(): "+p.message,p;}}catch(p){throw p.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+p.message,p;}a.call(window,f)}catch(p){P(p)}},Ag[b.toString()]?z("yt.scheduler.instance")?sf(g):R(g,0):g())});
...
t(Ig,vg);var Eg=new wg("screen-created",Ig),Jg=[],Kg=0;function Lg(a,b,c){var d=Mg;b={csn:a,parentVe:tg(b),childVes:Ra(c,function(f){return tg(f)})};
c=q(c);for(var e=c.next();!e.done;e=c.next())e=tg(e.value),(bb(e)||!e.trackingParams&&!e.veType)&&Re(Error("Child VE logged with no data"),"WARNING");c={ca:void 0,P:a};"UNDEFINED_CSN"==a?Ng("visualElementAttached",b,c):rg("visualElementAttached",b,d,c)}
...
;function Og(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||O("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.lb||O("AUTHORIZATION"))||(a?b="Bearer "+z("gapi.auth.getToken")().kb:b=Cc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=O("SESSION_INDEX",0),Q("pageid_as_header_web")&&(d["X-Goog-PageId"]=O("DELEGATED_SESSION_ID")));return d}
function Pg(a){a=Object.assign({},a);delete a.Authorization;var b=Cc();if(b){var c=new Sc;c.update(O("INNERTUBE_API_KEY",void 0));c.update(b);b=c.digest();c=3;Ba(b);void 0===c&&(c=0);if(!Tb){Tb={};for(var d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""),e=["+/=","+/","-_=","-_.","-_"],f=0;5>f;f++){var g=d.concat(e[f].split(""));Sb[f]=g;for(var h=0;h<g.length;h++){var k=g[h];void 0===Tb[k]&&(Tb[k]=h)}}}c=Sb[c];d=[];for(e=0;e<b.length;e+=3){var l=b[e],n=(f=e+1<b.length)?
...
;function Qg(a,b,c,d){Vb.set(""+a,b,c,"/",void 0===d?"youtube.com":d,!1)}
;function Rg(){var a=new Qd;(a=a.isAvailable()?new Wd(a,"yt.innertube"):null)||(a=new Rd("yt.innertube"),a=a.isAvailable()?a:null);this.f=a?new Md(a):null;this.g=document.domain||window.location.hostname}
Rg.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.f)try{this.f.set(a,b,B()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(id(b))}catch(f){return}else e=escape(b);Qg(a,e,c,this.g)};
Rg.prototype.get=function(a,b){var c=void 0,d=!this.f;if(!d)try{c=this.f.get(a)}catch(e){d=!0}if(d&&(c=Vb.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
Rg.prototype.remove=function(a){this.f&&this.f.remove(a);var b=this.g;Vb.remove(""+a,"/",void 0===b?"youtube.com":b)};var Sg=new Rg;function Tg(a,b,c,d){if(d)return null;d=Sg.get("nextId",!0)||1;var e=Sg.get("requests",!0)||{};e[d]={method:a,request:b,authState:Pg(c),requestTime:Math.round(T())};Sg.set("nextId",d+1,86400,!0);Sg.set("requests",e,86400,!0);return d}
function Ug(a){var b=Sg.get("requests",!0)||{};delete b[a];Sg.set("requests",b,86400,!0)}
function Vg(a){var b=Sg.get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(T())-d.requestTime)){var e=d.authState,f=Pg(Og(!1));db(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(T())),og(a,d.method,e,{}));delete b[c]}}Sg.set("requests",b,86400,!0)}}
;function Mg(a){var b=this;this.f=a||{innertubeApiKey:ae("INNERTUBE_API_KEY"),innertubeApiVersion:ae("INNERTUBE_API_VERSION"),Ba:O("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),Ca:O("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:ae("INNERTUBE_CONTEXT_CLIENT_VERSION"),Ea:ae("INNERTUBE_CONTEXT_HL"),Da:ae("INNERTUBE_CONTEXT_GL"),Fa:ae("INNERTUBE_HOST_OVERRIDE")||"",Ga:!!O("INNERTUBE_USE_THIRD_PARTY_AUTH",!1)};tf(function(){Vg(b)},0,5E3)}
...
timeout:d.timeout,withCredentials:!0},f="",g=a.f.Fa;g&&(f=g);g=a.f.Ga||!1;var h=Og(g,f,d);Object.assign(e.headers,h);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var k=je(""+f+("/youtubei/"+a.f.innertubeApiVersion+"/"+b),{alt:"json",key:a.f.innertubeApiKey}),l;if(d.retry&&Q("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(l=Tg(b,c,h,g))){var n=e.onSuccess,p=e.ma;e.onSuccess=function(w,r){Ug(l);n(w,r)};
c.ma=function(w,r){Ug(l);p(w,r)}}try{Q("use_fetch_for_op_xhr")?Ae(k,e):(e.method="POST",e.C||(e.C={}),De(k,e))}catch(w){if("InvalidAccessError"==w)l&&(Ug(l),l=0),P(Error("An extension is blocking network request."),"WARNING");
else throw w;}l&&tf(function(){Vg(a)},0,5E3)}
;var Wg=B().toString();
...
y("yt_logging_screen.setCurrentScreen",dh,void 0);function eh(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=O("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=O("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=I(J(3,window.location.href));g&&f.push(g);g=I(J(3,d));if(0<=Pa(f,g)||!g&&0==d.lastIndexOf("/",0))if(Q("autoescape_tempdata_url")&&(f=document.createElement("a"),Ib(f,d),d=f.href),d){g=d.match(kc);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&(b.itct||b.ved)&&
(b.csn=b.csn||ch()),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e="ST-"+Nb(d).toString(36),b=b?mc(b):"",Qg(e,b,k||5))}else k="ST-"+Nb(d).toString(36),b=b?mc(b):"",Qg(k,b,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var n=void 0===n?"":n;var p=void 0===p?window:p;c=p.location;a=nc(a,l)+n;a=a instanceof H?a:zb(a);c.href=xb(a)}return!0}
;function fh(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||eb(b);this.assets=a.assets||{};this.attrs=a.attrs||eb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
fh.prototype.clone=function(){var a=new fh,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==za(c)?a[b]=eb(c):a[b]=c}return a};function gh(){K.call(this);this.f=[]}
t(gh,K);gh.prototype.m=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.mb)}K.prototype.m.call(this)};var hh=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function ih(a){a=a||"";if(window.spf){var b=a.match(hh);spf.style.load(a,b?b[1]:"",void 0)}else jh(a)}
function jh(a){var b=kh(a),c=document.getElementById(b),d=c&&We(c,"loaded");d||c&&!d||(c=lh(a,b,function(){We(c,"loaded")||(Ue(c),ef(b),R(Ia(ff,b),0))}))}
function lh(a,b,c){var d=document.createElement("link");d.id=b;d.onload=function(){c&&setTimeout(c,0)};
a=ic(a);d.rel="stylesheet";d.href=a.f?a.f:lb(a).toString();(document.getElementsByTagName("head")[0]||document.body).appendChild(d);return d}
function kh(a){var b=ec(document,"A");Ib(b,new H(vb,a));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Nb(a)}
;function mh(a,b,c,d){K.call(this);var e=this;this.l=this.X=a;this.U=b;this.w=!1;this.api={};this.V=this.G=null;this.H=new M;Uc(this,Ia(Vc,this.H));this.i={};this.R=this.W=this.h=this.ba=this.f=null;this.K=!1;this.j=this.B=null;this.Y={};this.sa=["onReady"];this.aa=null;this.ja=NaN;this.S={};this.o=d;nh(this);this.Z("WATCH_LATER_VIDEO_ADDED",this.Ia.bind(this));this.Z("WATCH_LATER_VIDEO_REMOVED",this.Ja.bind(this));this.Z("onAdAnnounce",this.ua.bind(this));this.ta=new gh(this);Uc(this,Ia(Vc,this.ta));
...
m.loadNewVideoConfig=function(a){if(!this.g){this.T&&(S(this.T),this.T=0);a instanceof fh||(a=new fh(a));this.ba=a;this.f=a.clone();oh(this);this.W||(this.W=qh(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.l.style.width=vc(Number(a)||a);if(a=this.f.attrs.height)this.l.style.height=vc(Number(a)||a);ph(this);this.w&&rh(this)}};
...
function sh(a){var b=!0,c=th(a);c&&a.f&&(a=uh(a),b=We(c,"version")==a);return b&&!!z("yt.player.Application.create")}
...
a.K=!0;b?a.B():(kf(uh(a),a.B),ih(a.o?a.o.cssUrl:a.f.assets.css),xh(a)&&!c&&y("yt.player.Application.create",null,void 0))}}}
function th(a){var b=ac(a.h);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.h));return b}
...
function zh(a,b,c){var d=b[c];return function(){try{return a.aa=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.aa=e,ge(e))}}}
...
m.Z=function(a,b){var c=this,d=qh(this,b);if(d){if(!(0<=Pa(this.sa,a)||this.i[a])){var e=Ah(this,a);this.G&&this.G(a,e)}this.H.subscribe(a,d);"onReady"==a&&this.w&&R(function(){d(c.api)},0)}};
m.Oa=function(a,b){if(!this.g){var c=qh(this,b);c&&Gd(this.H,a,c)}};
function qh(a,b){var c=b;if("string"==typeof b){if(a.Y[b])return a.Y[b];c=function(){var d=z(b);d&&d.apply(u,arguments)};
a.Y[b]=c}return c?c:null}
function Ah(a,b){var c="ytPlayer"+b+a.U;a.i[b]=c;u[c]=function(d){var e=R(function(){if(!a.g){a.H.M(b,d);var f=a.S,g=String(e);g in f&&delete f[g]}},0);
cb(a.S,String(e))};
return c}
m.ua=function(a){ef("a11y-announce",a)};
m.Ia=function(a){ef("WATCH_LATER_VIDEO_ADDED",a)};
m.Ja=function(a){ef("WATCH_LATER_VIDEO_REMOVED",a)};
...
m.cancel=function(){this.B&&qf(uh(this),this.B);S(this.ja);this.K=!1};
m.m=function(){wh(this);if(this.j&&this.f&&this.j.destroy)try{this.j.destroy()}catch(b){P(b)}this.Y=null;for(var a in this.i)u[this.i[a]]=null;this.ba=this.f=this.api=null;delete this.X;delete this.l;K.prototype.m.call(this)};
...
;var Sh=z("ytLoggingLatencyUsageStats_")||{};y("ytLoggingLatencyUsageStats_",Sh,void 0);var Th=0;function Uh(a){Sh[a]=Sh[a]||{count:0};var b=Sh[a];b.count++;b.time=T();Th||(Th=tf(Vh,0,5E3));if(5<b.count){if(6==b.count&&1>1E5*Math.random()){b=0==a.indexOf("info")?"WARNING":"ERROR";var c=Error("CSI data exceeded logging limit with key");c.params=a;Re(c,b)}return!0}return!1}
...
;var ii={vc:!0},ji=!1;
function ki(){Oh().yt_lt="hot_bg";if(gi()){var a="hot_bg";var b=hi();if(b.gelInfos)b.gelInfos.info_yt_lt=!0;else{var c={};b.gelInfos=(c.info_yt_lt=!0,c)}if("yt_lt"in bi){b=bi.yt_lt;0<=Pa(ci,b)&&(a=!!a);"yt_lt"in ei&&"string"===typeof a&&(a=ei.yt_lt+a.toUpperCase());b=b.split(".");for(var d=c={},e=0;e<b.length-1;e++){var f=b[e];d[f]={};d=d[f]}d[b[b.length-1]]=a;a=Wh({},c)}else 0<=Pa(fi,"yt_lt")||(a=new ai("Unknown label logged with GEL CSI"),a.params="yt_lt",ge(a)),a=void 0;a&&gi()&&(b=hi(),"gelInfos"in
...
function mi(){Gh();if(!gi()){var a=Nh(),b=Oh(),c=a._start;for(f in a)if(0==f.lastIndexOf("_",0)&&Aa(a[f])){var d=f.slice(1);if(d in ii){var e=Ra(a[f],function(l){return Math.round(l-c)});
...
A(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||xa,X);function ni(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
...
function pi(a,b,c){if(Da(a)){b=["endSeconds","startSeconds","mediaContentUrl","suggestedQuality","videoId"];c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function qi(a,b,c,d){if(Da(a)&&!Aa(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};x(a)&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
;function ri(a){a=void 0===a?!1:a;K.call(this);this.f=new M(a);Uc(this,Ia(Vc,this.f))}
...
t(si,ri);function ti(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(id(a),d.i))}}
...
m.m=function(){var a=this.f;a.g||Gd(a.f,"command",this.qa,this);this.f=null;for(var b in this.h)vi(this,b);K.prototype.m.call(this)};function yi(a,b){ui.call(this,b);this.i=a;this.start()}
...
this))}
t(Di,Ai);m=Di.prototype;m.la=function(a,b,c){if(this.f.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&ni(a)){var d=b;if(Da(d[0])&&!Aa(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=pi.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=oi.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=qi.apply(window,d)}d=e}b.length=1;b[0]=d}this.f.handleExternalCall(a,b,c);ni(a)&&Ci(this,this.fa())}};
...
m.dispose=function(){Ai.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function Ei(a,b,c){K.call(this);this.f=a;this.i=c;this.j=U(window,"message",A(this.l,this));this.h=new si(this,a,b);Uc(this,Ia(Vc,this.h))}
...
Ei.prototype.m=function(){Sf(this.j);this.f=null;K.prototype.m.call(this)};function Fi(){var a=eb(Gi),b;return vd(new L(function(c,d){a.onSuccess=function(e){te(e)?c(e):d(new Hi("Request failed, status="+e.status,"net.badstatus",e))};
a.onError=function(e){d(new Hi("Unknown request error","net.unknown",e))};
a.O=function(e){d(new Hi("Request timed out","net.timeout",e))};
b=De("//googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof wd&&b.abort();
return td(c)})}
function Hi(a,b){E.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
t(Hi,E);function Ii(){this.g=0;this.f=null}
Ii.prototype.then=function(a,b,c){return 1===this.g&&a?(a=a.call(c,this.f),od(a)?a:Ji(a)):2===this.g&&b?(a=b.call(c,this.f),od(a)?a:Ki(a)):this};
...
;function Li(a){E.call(this,a.message||a.description||a.name);this.isMissing=a instanceof Mi;this.isTimeout=a instanceof Hi&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof wd}
t(Li,E);Li.prototype.name="BiscottiError";function Mi(){E.call(this,"Biscotti ID is missing from server")}
t(Mi,E);Mi.prototype.name="BiscottiMissingError";var Gi={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Ni=null;function de(){if("1"===Za(be(),"args","privembed"))return td(Error("Biscotti ID is not available in private embed mode"));Ni||(Ni=vd(Fi().then(Oi),function(a){return Pi(2,a)}));
return Ni}
...
function Qi(a,b){R(function(){vd(Fi().then(Oi,function(c){return Pi(b,c)}),xa)},a)}
function Ri(){try{var a=z("yt.ads.biscotti.getId_");return a?a():de()}catch(b){return td(b)}}
;function Si(a){if("1"!==Za(be(),"args","privembed")){a&&ce();try{Ri().then(function(){},function(){}),R(Si,18E5)}catch(b){P(b)}}}
;var Z=z("ytglobal.prefsUserPrefsPrefs_")||{};y("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function Ti(){this.f=O("ALT_PREF_COOKIE_NAME","PREF");var a=Vb.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
...
ya(Ti);var Xi=null,Yi=null,Zi=null,$i={};function aj(a){var b=a.id;a=a.ve_type;var c=ug++;a=new sg({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});$i[b]=a;b=ch();c=bh();b&&c&&Lg(b,c,[a])}
...
;y("yt.setConfig",N,void 0);y("yt.config.set",N,void 0);y("yt.setMsg",Te,void 0);y("yt.msgs.set",Te,void 0);y("yt.logging.errors.log",Re,void 0);
y("writeEmbed",function(){var a=O("PLAYER_CONFIG",void 0);Si(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=O("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);O("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");b="player";b=x(b)?ac(b):b;var d=Ch+"_"+(b[Ea]||(b[Ea]=++Fa)),e=Bh[d];e&&(void 0===f||f)?e.loadNewVideoConfig(a):(e=new mh(b,d,a,void 0),Bh[d]=e,ef("player-added",e.api),Uc(e,Ia(Dh,e)));a=e.api;Xi=a;a.addEventListener("onScreenChanged",
bj);a.addEventListener("onLogClientVeCreated",aj);a.addEventListener("onLogServerVeCreated",cj);a.addEventListener("onLogVeClicked",dj);a.addEventListener("onLogVesShown",ej);var f=O("POST_MESSAGE_ID","player");O("ENABLE_JS_API")?Zi=new Di(a):O("ENABLE_POST_API")&&x(f)&&x(c)&&(Yi=new Ei(window.parent,f,c),Zi=new yi(a,Yi.h));c=ae("BG_P");If(c)&&(O("BG_I")||O("BG_IU"))&&(Ef=!0,Df.initialize(O("BG_I",null),O("BG_IU",null),c,Hf,void 0));yf()},void 0);
y("yt.www.watch.ads.restrictioncookie.spr",function(a){Le(a+"mac_204?action_fcts=1");return!0},void 0);
var fj=fe(function(){var a=Nh(),b;(b=!Q("use_first_tick"))||(b=!("ol"in Nh()));if(b){b="ol";X.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),X.mark(b));b=T();a.ol&&(a._ol=a._ol||[a.ol],a._ol.push(b));a.ol=b;a=Fh();if(b=a.ol)vf(b),a.ol=0;a=hi();a.gelTicks&&(a.gelTicks.tick_ol=!0);T();gi()?(a=Qh(),Uh("tick_ol_"+a)||Rh("latencyActionTicked",{tickName:"ol",clientActionNonce:a},{timestamp:void 0}),a=!0):a=!1;if(!a&&!z("yt.timing.pingSent_")&&(b=O("TIMING_ACTION",void 0),a=Nh(),z("ytglobal.timingready_")&&
b&&a._start&&(b=li()))){ji||(Bg(Jh,new Hh(Math.round(b-a._start),void 0)),ji=!0);b=!0;var c=O("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&mi()}}a=Ti.getInstance();c=!!((Wi("f"+(Math.floor(119/31)+1))||0)&67108864);b=1<window.devicePixelRatio;document.body&&Yc(document.body,"exp-invert-logo")&&(b&&!Yc(document.body,"inverted-hdpi")?(d=document.body,d.classList?d.classList.add("inverted-hdpi"):Yc(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":
"inverted-hdpi")):!b&&Yc(document.body,"inverted-hdpi")&&Zc());c!=b&&(c="f"+(Math.floor(119/31)+1),d=Wi(c)||0,d=b?d|67108864:d&-67108865,0==d?delete Z[c]:(b=d.toString(16),Z[c]=b.toString()),a.save())}),gj=fe(function(){var a=Xi;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();O("PL_ATT")&&Df.dispose();a=0;for(var b=wf.length;a<b;a++)vf(wf[a]);wf.length=0;pf("//static.doubleclick.net/instream/ad_status.js");xf=!1;N("DCLKSTAT",0);Wc(Zi,Yi);if(a=Xi)a.removeEventListener("onScreenChanged",bj),a.removeEventListener("onLogClientVeCreated",aj),a.removeEventListener("onLogServerVeCreated",cj),a.removeEventListener("onLogVeClicked",dj),a.removeEventListener("onLogVesShown",ej),a.destroy();$i={}});
window.addEventListener?(window.addEventListener("load",fj),window.addEventListener("unload",gj)):window.attachEvent&&(window.attachEvent("onload",fj),window.attachEvent("onunload",gj));Ka("yt.abuse.player.botguardInitialized",z("yt.abuse.player.botguardInitialized")||Jf);Ka("yt.abuse.player.invokeBotguard",z("yt.abuse.player.invokeBotguard")||Kf);Ka("yt.abuse.dclkstatus.checkDclkStatus",z("yt.abuse.dclkstatus.checkDclkStatus")||zf);
Ka("yt.player.exports.navigate",z("yt.player.exports.navigate")||eh);Ka("yt.util.activity.init",z("yt.util.activity.init")||Wf);Ka("yt.util.activity.getTimeSinceActive",z("yt.util.activity.getTimeSinceActive")||Zf);Ka("yt.util.activity.setTimestamp",z("yt.util.activity.setTimestamp")||Xf);}).call(this);
