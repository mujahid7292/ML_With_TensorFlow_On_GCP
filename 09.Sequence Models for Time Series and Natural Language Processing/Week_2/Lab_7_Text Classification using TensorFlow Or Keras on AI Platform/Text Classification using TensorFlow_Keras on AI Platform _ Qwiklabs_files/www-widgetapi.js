...
function b(n){for(var r=g,q=0;64>q;q+=4)r[q/4]=n[q]<<24|n[q+1]<<16|n[q+2]<<8|n[q+3];for(q=16;80>q;q++)n=r[q-3]^r[q-8]^r[q-14]^r[q-16],r[q]=(n<<1|n>>>31)&4294967295;n=e[0];var v=e[1],w=e[2],F=e[3],ab=e[4];for(q=0;80>q;q++){if(40>q)if(20>q){var oa=F^v&(w^F);var La=1518500249}else oa=v^w^F,La=1859775393;else 60>q?(oa=v&w|F&(v|w),La=2400959708):(oa=v^w^F,La=3395469782);oa=((n<<5|n>>>27)&4294967295)+oa+ab+La+r[q]&4294967295;ab=F;F=w;w=(v<<30|v>>>2)&4294967295;v=n;n=oa}e[0]=e[0]+n&4294967295;e[1]=e[1]+
v&4294967295;e[2]=e[2]+w&4294967295;e[3]=e[3]+F&4294967295;e[4]=e[4]+ab&4294967295}
...
function Ee(a,b,c){Fe(a,b,c,null)||Yc(Wa(b,a))}
...
function Sg(){for(var a=eg,b=Math.round(U()),c=u(Pg),d=c.next();!d.done;d=c.next()){var e=u(d.value);d=e.next().value;var f=e.next().value;e=lb({context:Ug(a.f||Vg())});e.events=f;(f=Qg[d])&&Wg(e,d,f);delete Qg[d];Xg(e,b);Yg(a,"log_event",e,{retry:!0,onSuccess:function(){dg=Math.round(U()-b)}});
Og=!1}}
...
p.W=function(a){a.id=this.j;a.channel="widget";var b=xe(a),c=this.g,d=vc(this.f.src||"");var e=0==d.indexOf("https:")?[d]:c.f?[d.replace("http:","https:")]:c.h?[d]:[d,d.replace("http:","https:")];if(this.f.contentWindow)for(var f=0;f<e.length;f++)try{this.f.contentWindow.postMessage(b,e[f])}catch(Ta){if(Ta.name&&"SyntaxError"==Ta.name){if(!(Ta.message&&0<Ta.message.indexOf("target origin ''"))){var g=void 0,h=void 0,k=Ta;h=void 0===h?{}:h;h.name=O("INNERTUBE_CONTEXT_CLIENT_NAME",1);h.version=O("INNERTUBE_CONTEXT_CLIENT_VERSION",
void 0);var l=h||{},m="WARNING";m=void 0===m?"ERROR":m;g=void 0===g?!1:g;if(k){if(S("console_log_js_exceptions")){var n=k,r=[];r.push("Name: "+n.name);r.push("Message: "+n.message);n.hasOwnProperty("params")&&r.push("Error Params: "+JSON.stringify(n.params));r.push("File name: "+n.fileName);r.push("Stacktrace: "+n.stack);window.console.log(r.join("\n"),n)}if((window&&window.yterr||g)&&!(5<=nj)&&0!==k.sampleWeight){var q=void 0,v=k,w=l,F=bc(v),ab=F.message||"Unknown Error",oa=F.name||"UnknownError",
...
500),va+=w[Ha].length;else w[Ha]=String(JSON.stringify(T)).substring(0,500),va+=w[Ha].length;if(500<=va)break}else if(v.hasOwnProperty("params")&&v.params){var gc=v.params;if("object"===typeof v.params){var ig=0;for(q in gc)if(gc[q]){var jg="params."+q,kg=String(JSON.stringify(gc[q])).substr(0,500);w[jg]=kg;ig+=jg.length+kg.length;if(500<ig)break}}else w.params=String(JSON.stringify(gc)).substr(0,500)}navigator.vendor&&!w.hasOwnProperty("vendor")&&(w.vendor=navigator.vendor);var Ed={message:ab,name:oa,
lineNumber:La,fileName:Bj,stack:Cj,params:w},lg=Number(v.columnNumber);isNaN(lg)||(Ed.lineNumber=Ed.lineNumber+":"+lg);for(var ia,Ia=Ed,mg=u(ij),Fd=mg.next();!Fd.done;Fd=mg.next()){var Gd=Fd.value;if(Gd.V[Ia.name])for(var ng=u(Gd.V[Ia.name]),Hd=ng.next();!Hd.done;Hd=ng.next()){var og=Hd.value,hc=Ia.message.match(og.regexp);if(hc){Ia.params["error.original"]=hc[0];for(var Id=og.groups,pg={},Ua=0;Ua<Id.length;Ua++)pg[Id[Ua]]=hc[Ua+1],Ia.params["error."+Id[Ua]]=hc[Ua+1];Ia.message=Gd.ca(pg);break}}}ia=
...
yg.weight;break a}}Ld=1}var Nd={level:"ERROR_LEVEL_UNKNOWN",message:Fj,errorClassName:Gj,sampleWeight:Ld};"ERROR"===qg?Nd.level="ERROR_LEVEL_ERROR":"WARNING"===qg&&(Nd.level="ERROR_LEVEL_WARNNING");var Hj={isObfuscated:!0,browserStackInfo:rb},Va={pageUrl:window.location.href};O("FEXP_EXPERIMENTS")&&(Va.experimentIds=O("FEXP_EXPERIMENTS"));Va.kvPairs=[];var Od=P.params;if(Od)for(var zg=u(Object.keys(Od)),Pd=zg.next();!Pd.done;Pd=zg.next()){var Ag=Pd.value;Va.kvPairs.push({key:"client."+Ag,value:String(Od[Ag])})}var Bg=
O("SERVER_NAME",void 0),Cg=O("SERVER_VERSION",void 0);Bg&&Cg&&(Va.kvPairs.push({key:"server.name",value:Bg}),Va.kvPairs.push({key:"server.version",value:Cg}));var Ij={errorMetadata:Va,stackTrace:Hj,logMessage:Nd};ic=void 0===ic?{}:ic;var Dg=hj;O("ytLoggingEventsDefaultDisabled",!1)&&hj==hj&&(Dg=null);var Jj=Dg,Z=ic;Z=void 0===Z?{}:Z;var sb={};sb.eventTimeMs=Math.round(Z.timestamp||U());sb.clientError=Ij;var Kj=String;if(Z.timestamp)var Eg=-1;else{var Fg=C("_lact",window);Eg=null==Fg?-1:Math.max(Date.now()-
...
void 0))for(var Kg=u(Object.keys(Td)),Vd=Kg.next();!Vd.done;Vd=Kg.next()){var Lg=Vd.value;wa.u[Lg]=Td[Lg]}var Mg=O("SERVER_NAME",void 0),Ng=O("SERVER_VERSION",void 0);Mg&&Ng&&(wa.u["server.name"]=Mg,wa.u["server.version"]=Ng)}nh(O("ECATCHER_REPORT_HOST","")+"/error_204",wa)}mj.add(ia.message);nj++}}}}}else throw Ta;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function vj(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
